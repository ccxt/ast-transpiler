...
`;
  ...
  printNativeScalarParse(node, callee) {
    const args = _optionalChain([node, 'optionalAccess', _460 => _460.arguments]);
  ...
  printNativePadStart(node, name) {
    const args = _optionalChain([node, 'optionalAccess', _461 => _461.arguments]);
    ...
    const receiver = _optionalChain([node, 'access', _462 => _462.expression, 'optionalAccess', _463 => _463.expression]);
...
`;
  ...
  printMathFloorCall(node, _identation, parsedArg = void 0) {
    return `(Math.floor(Double.parseDouble(${this.javaStringBoxText(_optionalChain([node, 'optionalAccess', _520 => _520.arguments, 'optionalAccess', _521 => _521[0]]), parsedArg)})))`;
  }
  printMathRoundCall(node, _identation, parsedArg = void 0) {
    return `Math.round(Double.parseDouble(${this.javaStringBoxText(_optionalChain([node, 'optionalAccess', _522 => _522.arguments, 'optionalAccess', _523 => _523[0]]), parsedArg)}))`;
  }
  printMathCeilCall(node, _identation, parsedArg = void 0) {
    return `Math.ceil(Double.parseDouble(${this.javaStringBoxText(_optionalChain([node, 'optionalAccess', _524 => _524.arguments, 'optionalAccess', _525 => _525[0]]), parsedArg)}))`;
  }
