...
`;
  ...
  printNativePromiseAllCall(node) {
    const awaitNode = _optionalChain([node, 'optionalAccess', _516 => _516.parent]);
    if (_optionalChain([awaitNode, 'optionalAccess', _517 => _517.kind]) !== _typescript2.default.SyntaxKind.AwaitExpression) {
      return void 0;
    }
    const listNode = _optionalChain([node, 'access', _518 => _518.arguments, 'optionalAccess', _519 => _519[0]]);
    if (_optionalChain([listNode, 'optionalAccess', _520 => _520.kind]) !== _typescript2.default.SyntaxKind.ArrayLiteralExpression) {
      return void 0;
    }
    ...
    if (_optionalChain([awaitNode, 'access', _521 => _521.parent, 'optionalAccess', _522 => _522.kind]) === _typescript2.default.SyntaxKind.ExpressionStatement) {
      return allOf;
    }
  ...
  isConstBoundIdentifier(node) {
    ...
    const declaration = _optionalChain([this, 'access', _523 => _523.getChecker, 'call', _524 => _524(), 'access', _525 => _525.getSymbolAtLocation, 'call', _526 => _526(node), 'optionalAccess', _527 => _527.valueDeclaration]);
    return _optionalChain([declaration, 'optionalAccess', _528 => _528.kind]) === _typescript2.default.SyntaxKind.VariableDeclaration && (_typescript2.default.getCombinedNodeFlags(declaration) & _typescript2.default.NodeFlags.Const) === _typescript2.default.NodeFlags.Const;
  }
  printPromiseAllCall(node, identation, parsedArg = void 0) {
