...
`;
  ...
  javaNativeIndexOfCall(node, name, parsedArg) {
    ...
    const receiver = _optionalChain([node, 'optionalAccess', _516 => _516.expression, 'optionalAccess', _517 => _517.expression]);
    if (receiver === void 0) {
      return void 0;
    }
    const checker = this.getChecker();
    ...
    const arg = _optionalChain([node, 'access', _518 => _518.arguments, 'optionalAccess', _519 => _519[0]]);
    if (arg === void 0) {
      return void 0;
    }
