...
`;
  ...
  javaNativeSplitCall(node, name, parsedArg) {
    ...
    if (_optionalChain([callee, 'access', _460 => _460.name, 'optionalAccess', _461 => _461.escapedText]) !== "split" || _optionalChain([node, 'access', _462 => _462.arguments, 'optionalAccess', _463 => _463.length]) !== 1) {
      return void 0;
    }
