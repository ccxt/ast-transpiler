...
var CSharpTranspiler = class extends BaseTranspiler {
  ...
  csharpForBoundsCounter(loop, counter, receiver) {
    ...
    if (_optionalChain([condition, 'optionalAccess', _86 => _86.kind]) !== _typescript2.default.SyntaxKind.BinaryExpression || condition.operatorToken.kind !== _typescript2.default.SyntaxKind.LessThanToken) {
      return false;
    }
    const left = this.csharpUnparenthesized(condition.left);
    const right = this.csharpUnparenthesized(condition.right);
    if (!_typescript2.default.isIdentifier(left) || !_typescript2.default.isPropertyAccessExpression(right) || _optionalChain([right, 'access', _87 => _87.name, 'optionalAccess', _88 => _88.escapedText]) !== "length") {
      return false;
    }
    ...
    const declaration = _optionalChain([this, 'access', _89 => _89.getChecker, 'call', _90 => _90(), 'access', _91 => _91.getSymbolAtLocation, 'call', _92 => _92(counter), 'optionalAccess', _93 => _93.valueDeclaration]);
    const checker = this.getChecker();
    return declaration !== void 0 && _optionalChain([checker, 'access', _94 => _94.getSymbolAtLocation, 'call', _95 => _95(left), 'optionalAccess', _96 => _96.valueDeclaration]) === declaration && _optionalChain([checker, 'access', _97 => _97.getSymbolAtLocation, 'call', _98 => _98(receiverExpression), 'optionalAccess', _99 => _99.valueDeclaration]) === _optionalChain([checker, 'access', _100 => _100.getSymbolAtLocation, 'call', _101 => _101(receiver), 'optionalAccess', _102 => _102.valueDeclaration]);
  }
  ...
  csharpCounterStartsAtZero(loop, counter) {
    ...
    if (_optionalChain([initializer, 'optionalAccess', _103 => _103.kind]) !== _typescript2.default.SyntaxKind.VariableDeclarationList || initializer.declarations.length !== 1) {
      return false;
    }
    ...
    return Number(declaration.initializer.text) >= 0 && _optionalChain([this, 'access', _104 => _104.getChecker, 'call', _105 => _105(), 'access', _106 => _106.getSymbolAtLocation, 'call', _107 => _107(counter), 'optionalAccess', _108 => _108.valueDeclaration]) === declaration;
  }
  // the header moves the counter forward: a decrement could leave a negative index behind
  csharpCounterAdvances(loop, counter) {
    const declaration = _optionalChain([this, 'access', _109 => _109.getChecker, 'call', _110 => _110(), 'access', _111 => _111.getSymbolAtLocation, 'call', _112 => _112(counter), 'optionalAccess', _113 => _113.valueDeclaration]);
    ...
    if (incrementor.kind === _typescript2.default.SyntaxKind.PostfixUnaryExpression || incrementor.kind === _typescript2.default.SyntaxKind.PrefixUnaryExpression) {
      return incrementor.operator === _typescript2.default.SyntaxKind.PlusPlusToken && _optionalChain([this, 'access', _114 => _114.getChecker, 'call', _115 => _115(), 'access', _116 => _116.getSymbolAtLocation, 'call', _117 => _117(incrementor.operand), 'optionalAccess', _118 => _118.valueDeclaration]) === declaration;
    }
    if (incrementor.kind === _typescript2.default.SyntaxKind.BinaryExpression && incrementor.operatorToken.kind === _typescript2.default.SyntaxKind.PlusEqualsToken) {
      return _optionalChain([this, 'access', _119 => _119.getChecker, 'call', _120 => _120(), 'access', _121 => _121.getSymbolAtLocation, 'call', _122 => _122(incrementor.left), 'optionalAccess', _123 => _123.valueDeclaration]) === declaration && _typescript2.default.isNumericLiteral(incrementor.right) && Number(incrementor.right.text) >= 0;
    }
    return false;
  }
  // a write to the counter in the body invalidates the bound the condition proved
  csharpCounterUnwrittenIn(range, counter) {
    const declaration = _optionalChain([this, 'access', _124 => _124.getChecker, 'call', _125 => _125(), 'access', _126 => _126.getSymbolAtLocation, 'call', _127 => _127(counter), 'optionalAccess', _128 => _128.valueDeclaration]);
  ...
  csharpReceiverIntactIn(range, receiver) {
    const declaration = _optionalChain([this, 'access', _129 => _129.getChecker, 'call', _130 => _130(), 'access', _131 => _131.getSymbolAtLocation, 'call', _132 => _132(receiver), 'optionalAccess', _133 => _133.valueDeclaration]);
    if (declaration === void 0) {
      return false;
    }
    let intact = true;
    this.csharpWalkIdentifiers(range, (identifier) => {
      ...
      const parent = identifier.parent;
      if (_typescript2.default.isPropertyAccessExpression(parent) && parent.expression === identifier && _optionalChain([parent, 'access', _134 => _134.name, 'optionalAccess', _135 => _135.escapedText]) === "length") {
        return;
      }
  ...
  csharpIsSameDeclaration(identifier, declaration) {
    return _optionalChain([this, 'access', _136 => _136.getChecker, 'call', _137 => _137(), 'access', _138 => _138.getSymbolAtLocation, 'call', _139 => _139(identifier), 'optionalAccess', _140 => _140.valueDeclaration]) === declaration;
  }
  ...
  csharpLiteralDeclaresKey(node, expression, key, isNumberKey) {
    ...
    const declarations = _nullishCoalesce(_optionalChain([symbol, 'optionalAccess', _141 => _141.declarations]), () => ( []));
  ...
  printWrappedUnknownThisProperty(node) {
    ...
    if (_optionalChain([type, 'optionalAccess', _142 => _142.declaration]) === void 0) {
      let parsedArguments = _optionalChain([node, 'access', _143 => _143.arguments, 'optionalAccess', _144 => _144.map, 'call', _145 => _145((a) => this.printNode(a, 0)), 'access', _146 => _146.join, 'call', _147 => _147(", ")]);
      parsedArguments = parsedArguments ? parsedArguments : "";
      const propName = _optionalChain([node, 'access', _148 => _148.expression, 'optionalAccess', _149 => _149.name, 'access', _150 => _150.escapedText]);
      const isAsyncDecl = _optionalChain([node, 'optionalAccess', _151 => _151.parent, 'optionalAccess', _152 => _152.kind]) === _typescript2.default.SyntaxKind.AwaitExpression;
  ...
  printOutOfOrderCallExpressionIfAny(node, identation) {
    if (node.expression.kind === _typescript2.default.SyntaxKind.PropertyAccessExpression) {
      ...
      const leftSide = _optionalChain([node, 'access', _153 => _153.expression, 'optionalAccess', _154 => _154.expression]);
  ...
  csharpDeclaredTypeOfBinding(node) {
    ...
    const declaration = _optionalChain([symbol, 'optionalAccess', _155 => _155.valueDeclaration]);
    if (declaration === void 0) {
      return void 0;
    }
  ...
  csharpOperandsAreNumbers(node) {
    const isNumber = (operand) => {
      let flags;
      try {
        flags = _optionalChain([this, 'access', _156 => _156.getChecker, 'call', _157 => _157(), 'access', _158 => _158.getTypeAtLocation, 'call', _159 => _159(operand), 'optionalAccess', _160 => _160.flags]);
      } catch (e) {
        return false;
      }
  ...
  csharpNativeReceiver(node) {
    if (_optionalChain([node, 'optionalAccess', _161 => _161.kind]) === _typescript2.default.SyntaxKind.ParenthesizedExpression) {
    ...
    if (_typescript2.default.isPropertyAccessExpression(node) && _optionalChain([node, 'access', _162 => _162.expression, 'optionalAccess', _163 => _163.kind]) === _typescript2.default.SyntaxKind.ThisKeyword) {
      const name = _optionalChain([node, 'access', _164 => _164.name, 'optionalAccess', _165 => _165.escapedText]);
  ...
  csharpTypedLocalType(node) {
    const declaration = _optionalChain([this, 'access', _166 => _166.getChecker, 'call', _167 => _167(), 'access', _168 => _168.getSymbolAtLocation, 'call', _169 => _169(node), 'optionalAccess', _170 => _170.valueDeclaration]);
  ...
  csharpNativeStringKey(key) {
    if (_optionalChain([key, 'optionalAccess', _171 => _171.kind]) === _typescript2.default.SyntaxKind.ParenthesizedExpression) {
  ...
  csharpIsArrayType(type) {
    ...
    return _optionalChain([type, 'optionalAccess', _172 => _172.symbol, 'optionalAccess', _173 => _173.escapedName]) === "Array";
  }
...
`;
  ...
  csharpCallReturnType(initializer) {
    if (_optionalChain([initializer, 'optionalAccess', _174 => _174.kind]) === _typescript2.default.SyntaxKind.PropertyAccessExpression) {
      return _optionalChain([initializer, 'access', _175 => _175.name, 'optionalAccess', _176 => _176.escapedText]) === "length" ? "int" : void 0;
    }
    if (_optionalChain([initializer, 'optionalAccess', _177 => _177.kind]) !== _typescript2.default.SyntaxKind.CallExpression) {
      return void 0;
    }
    const expression = initializer.expression;
    if (_optionalChain([expression, 'optionalAccess', _178 => _178.kind]) !== _typescript2.default.SyntaxKind.PropertyAccessExpression) {
      return void 0;
    }
    const methodName = _optionalChain([expression, 'access', _179 => _179.name, 'optionalAccess', _180 => _180.escapedText]);
    const target = expression.expression;
    if (_optionalChain([target, 'optionalAccess', _181 => _181.kind]) === _typescript2.default.SyntaxKind.ThisKeyword) {
      if (!this.csharpCalleeResolves(initializer)) {
        return void 0;
      }
      return CSHARP_THIS_RETURN_TYPES[methodName];
    }
    if (_optionalChain([target, 'optionalAccess', _182 => _182.kind]) === _typescript2.default.SyntaxKind.Identifier) {
  ...
  csharpCalleeResolves(node) {
    ...
    return _optionalChain([signature, 'optionalAccess', _183 => _183.declaration]) !== void 0;
  }
  ...
  csharpTypeOfInitializer(initializer) {
    switch (_optionalChain([initializer, 'optionalAccess', _184 => _184.kind])) {
      case _typescript2.default.SyntaxKind.StringLiteral:
  ...
  csharpEnclosingFunction(node) {
    let current = _optionalChain([node, 'optionalAccess', _185 => _185.parent]);
    while (current) {
      switch (current.kind) {
        case _typescript2.default.SyntaxKind.MethodDeclaration:
        case _typescript2.default.SyntaxKind.FunctionDeclaration:
  ...
  csharpTypeNameIsShadowed(scope, csharpType) {
    ...
    const visit = (n) => {
      ...
      if (isBinding && _optionalChain([n, 'access', _186 => _186.name, 'optionalAccess', _187 => _187.kind]) === _typescript2.default.SyntaxKind.Identifier) {
  ...
  csharpLocalIsSafeToType(scope, declaration, varName, csharpType, safeAccessor = false) {
    ...
    const visit = (n) => {
      ...
      if (n.kind === _typescript2.default.SyntaxKind.Identifier && n.escapedText === varName && n !== declaration.name) {
        const parent = n.parent;
        if (_optionalChain([parent, 'optionalAccess', _188 => _188.kind]) === _typescript2.default.SyntaxKind.VariableDeclaration && parent.name === n) {
          return;
        }
        if (_optionalChain([parent, 'optionalAccess', _189 => _189.kind]) === _typescript2.default.SyntaxKind.PostfixUnaryExpression || _optionalChain([parent, 'optionalAccess', _190 => _190.kind]) === _typescript2.default.SyntaxKind.PrefixUnaryExpression) {
        ...
        if (_optionalChain([parent, 'optionalAccess', _191 => _191.kind]) === _typescript2.default.SyntaxKind.SpreadElement) {
          safe = false;
          return;
        }
        if (_optionalChain([parent, 'optionalAccess', _192 => _192.kind]) === _typescript2.default.SyntaxKind.ArrayLiteralExpression && _optionalChain([parent, 'access', _193 => _193.parent, 'optionalAccess', _194 => _194.kind]) === _typescript2.default.SyntaxKind.BinaryExpression && parent.parent.left === parent && parent.parent.operatorToken.kind === _typescript2.default.SyntaxKind.EqualsToken) {
          safe = false;
          return;
        }
        if (_optionalChain([parent, 'optionalAccess', _195 => _195.kind]) === _typescript2.default.SyntaxKind.PropertyAccessExpression && parent.expression === n) {
          const method = _optionalChain([parent, 'access', _196 => _196.name, 'optionalAccess', _197 => _197.escapedText]);
        ...
        if (safeAccessor) {
          if (_optionalChain([parent, 'optionalAccess', _198 => _198.kind]) === _typescript2.default.SyntaxKind.VariableDeclaration && _optionalChain([parent, 'access', _199 => _199.name, 'optionalAccess', _200 => _200.kind]) === _typescript2.default.SyntaxKind.ArrayBindingPattern && !this.csharpTypeIsList(csharpType)) {
            safe = false;
            return;
          }
        ...
        if (_optionalChain([parent, 'optionalAccess', _201 => _201.kind]) === _typescript2.default.SyntaxKind.BinaryExpression && parent.left === n) {
  ...
  getCSharpLocalType(declaration) {
    ...
    const sourceName = _optionalChain([declaration, 'access', _202 => _202.name, 'optionalAccess', _203 => _203.escapedText]);
  ...
  csharpIsSafeAccessorCall(initializer) {
    if (_optionalChain([initializer, 'optionalAccess', _204 => _204.kind]) !== _typescript2.default.SyntaxKind.CallExpression) {
      return false;
    }
    const expression = initializer.expression;
    if (_optionalChain([expression, 'optionalAccess', _205 => _205.kind]) !== _typescript2.default.SyntaxKind.PropertyAccessExpression || _optionalChain([expression, 'access', _206 => _206.expression, 'optionalAccess', _207 => _207.kind]) !== _typescript2.default.SyntaxKind.ThisKeyword) {
      return false;
    }
    return CSHARP_SAFE_ACCESSOR_NAMES.indexOf(_optionalChain([expression, 'access', _208 => _208.name, 'optionalAccess', _209 => _209.escapedText])) >= 0;
  }
  ...
  csharpIsClassThrowArgument(node) {
    ...
    while (current.parent) {
      ...
      if (parent.kind === _typescript2.default.SyntaxKind.NewExpression && _optionalChain([parent, 'access', _210 => _210.arguments, 'optionalAccess', _211 => _211.indexOf, 'call', _212 => _212(current)]) >= 0) {
        current = parent;
        continue;
      }
  ...
  csharpIsDeleteKey(node) {
    ...
    return _optionalChain([access, 'optionalAccess', _213 => _213.kind]) === _typescript2.default.SyntaxKind.ElementAccessExpression && access.argumentExpression === value && _optionalChain([access, 'access', _214 => _214.parent, 'optionalAccess', _215 => _215.kind]) === _typescript2.default.SyntaxKind.DeleteExpression;
  }
  ...
  csharpIsLeftPlusOperand(node) {
    ...
    const parent = value.parent;
    if (_optionalChain([parent, 'optionalAccess', _216 => _216.kind]) !== _typescript2.default.SyntaxKind.BinaryExpression || parent.left !== value) {
      return false;
    }
    const op = parent.operatorToken.kind;
  ...
  printVariableDeclarationList(node, identation) {
    const declaration = node.declarations[0];
    if (this.removeVariableDeclarationForFunctionExpression && _optionalChain([declaration, 'optionalAccess', _217 => _217.initializer]) && _typescript2.default.isFunctionExpression(declaration.initializer)) {
      return this.printNode(declaration.initializer, identation).trimEnd();
    }
    if (_optionalChain([declaration, 'optionalAccess', _218 => _218.name, 'access', _219 => _219.kind]) === _typescript2.default.SyntaxKind.ArrayBindingPattern) {
...
`;
    ...
    const isNew = _optionalChain([declaration, 'optionalAccess', _220 => _220.initializer]) && declaration.initializer.kind === _typescript2.default.SyntaxKind.NewExpression;
    const varToken = isNew ? "var " : this.VAR_TOKEN + " ";
    if (_optionalChain([declaration, 'optionalAccess', _221 => _221.initializer]) && declaration.initializer === void 0) {
  ...
  printCustomDefaultValueIfNeeded(node) {
    ...
    if (_optionalChain([node, 'optionalAccess', _222 => _222.escapedText]) === "undefined" && _optionalChain([this, 'access', _223 => _223.getChecker, 'call', _224 => _224(), 'access', _225 => _225.getTypeAtLocation, 'call', _226 => _226(_optionalChain([node, 'optionalAccess', _227 => _227.parent])), 'optionalAccess', _228 => _228.flags]) === _typescript2.default.TypeFlags.Number) {
      return this.UNDEFINED_TOKEN;
    }
    return void 0;
  }
  ...
  csharpBooleanReturnType(node) {
    if (_optionalChain([node, 'optionalAccess', _229 => _229.kind]) !== _typescript2.default.SyntaxKind.MethodDeclaration || this.isAsyncFunction(node)) {
      return void 0;
    }
  ...
  csharpConditionPrintsBool(node) {
    switch (_optionalChain([node, 'optionalAccess', _230 => _230.kind])) {
      case _typescript2.default.SyntaxKind.TrueKeyword:
      case _typescript2.default.SyntaxKind.FalseKeyword:
        return true;
      case _typescript2.default.SyntaxKind.ParenthesizedExpression:
  ...
  csharpIsCheckedBoolean(node) {
    const type = this.getChecker().getTypeAtLocation(node);
    return ((_nullishCoalesce(_optionalChain([type, 'optionalAccess', _231 => _231.flags]), () => ( 0))) & _typescript2.default.TypeFlags.BooleanLike) !== 0;
  }
  ...
  csharpIdentifierPrintsBool(node) {
    ...
    const declaration = _optionalChain([this, 'access', _232 => _232.getChecker, 'call', _233 => _233(), 'access', _234 => _234.getSymbolAtLocation, 'call', _235 => _235(node), 'optionalAccess', _236 => _236.valueDeclaration]);
    if (declaration === void 0 || !_typescript2.default.isVariableDeclaration(declaration) || _optionalChain([declaration, 'access', _237 => _237.name, 'optionalAccess', _238 => _238.kind]) !== _typescript2.default.SyntaxKind.Identifier) {
      return false;
    }
  ...
  printCondition(node, identation) {
    ...
    if (_optionalChain([node, 'optionalAccess', _239 => _239.kind]) === _typescript2.default.SyntaxKind.PrefixUnaryExpression && node.operator === _typescript2.default.SyntaxKind.ExclamationToken) {
      return this.printPrefixUnaryExpression(node, identation);
    }
    const printed = this.printNode(node, 0);
  ...
  csharpConditionParensIfNeeded(node, printed) {
    if (_optionalChain([node, 'optionalAccess', _240 => _240.kind]) !== _typescript2.default.SyntaxKind.BinaryExpression) {
      return printed;
    }
    const op = node.operatorToken.kind;
    ...
    const parent = node.parent;
    const underNot = _optionalChain([parent, 'optionalAccess', _241 => _241.kind]) === _typescript2.default.SyntaxKind.PrefixUnaryExpression && parent.operator === _typescript2.default.SyntaxKind.ExclamationToken;
    const underAnd = op === _typescript2.default.SyntaxKind.BarBarToken && _optionalChain([parent, 'optionalAccess', _242 => _242.kind]) === _typescript2.default.SyntaxKind.BinaryExpression && parent.operatorToken.kind === _typescript2.default.SyntaxKind.AmpersandAmpersandToken;
  ...
  printNewExpression(node, identation) {
    let expression = _optionalChain([node, 'access', _243 => _243.expression, 'optionalAccess', _244 => _244.escapedText]);
    expression = expression ? expression : this.printNode(node.expression);
    if (expression === "Error") {
      expression = "Exception";
    }
  ...
  printThrowStatement(node, identation) {
    ...
    if (node.expression.kind === _typescript2.default.SyntaxKind.NewExpression) {
      const expression = node.expression;
      const argumentsExp = _nullishCoalesce(_optionalChain([expression, 'optionalAccess', _245 => _245.arguments]), () => ( []));
      ...
      if (expression.expression.kind === _typescript2.default.SyntaxKind.Identifier) {
        ...
        if (symbol) {
          const declarations = _nullishCoalesce(_optionalChain([this, 'access', _246 => _246.getChecker, 'call', _247 => _247(), 'access', _248 => _248.getDeclaredTypeOfSymbol, 'call', _249 => _249(symbol), 'access', _250 => _250.symbol, 'optionalAccess', _251 => _251.declarations]), () => ( []));
...
var GoTranspiler = class extends BaseTranspiler {
  ...
  printStruct(node, indentation) {
    const rows = [];
    if (_optionalChain([node, 'optionalAccess', _252 => _252.heritageClauses, 'optionalAccess', _253 => _253.length]) > 0) {
...
`;
  ...
  getAsyncBodyName(node, goName) {
    ...
    try {
      const parent = _optionalChain([node, 'optionalAccess', _254 => _254.parent]);
      if (parent && _typescript2.default.isClassDeclaration(parent)) {
        parent.members.forEach((member) => remember(_optionalChain([member, 'optionalAccess', _255 => _255.name, 'optionalAccess', _256 => _256.escapedText])));
        ...
        parent.statements.forEach((statement) => {
          if (_typescript2.default.isFunctionDeclaration(statement)) {
            remember(_optionalChain([statement, 'optionalAccess', _257 => _257.name, 'optionalAccess', _258 => _258.escapedText]));
          }
        });
      }
    } catch (e3) {
  ...
  printAsyncTrampolineArgs(node) {
    ...
    (_nullishCoalesce(_optionalChain([node, 'optionalAccess', _259 => _259.parameters]), () => ( []))).forEach((param) => {
  ...
  applyAsyncSuffixToCallee(nameNode, goName) {
    ...
    try {
      ...
      decls = _optionalChain([symbol, 'optionalAccess', _260 => _260.declarations]);
    } catch (e4) {
      return goName;
    }
  ...
  goTypeOfInitializer(initializer, printedValue) {
    switch (_optionalChain([initializer, 'optionalAccess', _261 => _261.kind])) {
      case _typescript2.default.SyntaxKind.StringLiteral:
      case _typescript2.default.SyntaxKind.NoSubstitutionTemplateLiteral:
        return "string";
      case _typescript2.default.SyntaxKind.TrueKeyword:
  ...
  goLocalStaticType(node) {
    const declaration = _optionalChain([this, 'access', _262 => _262.getChecker, 'call', _263 => _263(), 'access', _264 => _264.getSymbolAtLocation, 'call', _265 => _265(node), 'optionalAccess', _266 => _266.valueDeclaration]);
    if (_optionalChain([declaration, 'optionalAccess', _267 => _267.kind]) !== _typescript2.default.SyntaxKind.VariableDeclaration || declaration.initializer === void 0) {
      return void 0;
    }
    if (_optionalChain([declaration, 'access', _268 => _268.parent, 'optionalAccess', _269 => _269.parent, 'optionalAccess', _270 => _270.kind]) !== _typescript2.default.SyntaxKind.FirstStatement) {
      return void 0;
    }
  ...
  goOperandStaticType(node, printedText) {
    switch (_optionalChain([node, 'optionalAccess', _271 => _271.kind])) {
      case _typescript2.default.SyntaxKind.StringLiteral:
      case _typescript2.default.SyntaxKind.NoSubstitutionTemplateLiteral:
        return "string";
      case _typescript2.default.SyntaxKind.NumericLiteral:
      ...
      case _typescript2.default.SyntaxKind.BinaryExpression:
        return _optionalChain([this, 'access', _272 => _272.goNativeArithmetic, 'call', _273 => _273(node), 'optionalAccess', _274 => _274.goType]);
      case _typescript2.default.SyntaxKind.Identifier:
  ...
  isNonZeroIntegerLiteral(node) {
    if (_optionalChain([node, 'optionalAccess', _275 => _275.kind]) === _typescript2.default.SyntaxKind.ParenthesizedExpression) {
      return this.isNonZeroIntegerLiteral(node.expression);
    }
    return _optionalChain([node, 'optionalAccess', _276 => _276.kind]) === _typescript2.default.SyntaxKind.NumericLiteral && /^[1-9][0-9]*$/.test(node.text);
  }
  ...
  goNativeOperandText(node, printedText) {
    ...
    if (_optionalChain([node, 'optionalAccess', _277 => _277.kind]) !== _typescript2.default.SyntaxKind.BinaryExpression || text.startsWith("(")) {
      return text;
    }
  ...
  goNativeBinaryText(node, symbol, leftText, rightText) {
    const operandText = (operand, printed) => {
      const isBinary = _optionalChain([operand, 'optionalAccess', _278 => _278.kind]) === _typescript2.default.SyntaxKind.BinaryExpression;
  ...
  goEnclosingFunction(node) {
    let current = _optionalChain([node, 'optionalAccess', _279 => _279.parent]);
    while (current) {
      switch (current.kind) {
        case _typescript2.default.SyntaxKind.MethodDeclaration:
        case _typescript2.default.SyntaxKind.FunctionDeclaration:
  ...
  goTypeNameIsShadowed(scope, goType) {
    ...
    const visit = (n) => {
      ...
      const isBinding = n.kind === _typescript2.default.SyntaxKind.Parameter || n.kind === _typescript2.default.SyntaxKind.VariableDeclaration;
      if (isBinding && _optionalChain([n, 'access', _280 => _280.name, 'optionalAccess', _281 => _281.kind]) === _typescript2.default.SyntaxKind.Identifier) {
  ...
  goLocalIsSafeToType(scope, declaration, varName, goType) {
    ...
    const visit = (n) => {
      ...
      if (n.kind === _typescript2.default.SyntaxKind.Identifier && n.escapedText === varName && n !== declaration.name) {
        const parent = n.parent;
        if (_optionalChain([parent, 'optionalAccess', _282 => _282.kind]) === _typescript2.default.SyntaxKind.PropertyAccessExpression && parent.expression === n && _optionalChain([parent, 'access', _283 => _283.name, 'optionalAccess', _284 => _284.escapedText]) === "push") {
          safe = false;
          return;
        }
        if (_optionalChain([parent, 'optionalAccess', _285 => _285.kind]) === _typescript2.default.SyntaxKind.VariableDeclaration && parent.name === n) {
          return;
        }
        if (_optionalChain([parent, 'optionalAccess', _286 => _286.kind]) === _typescript2.default.SyntaxKind.PostfixUnaryExpression || _optionalChain([parent, 'optionalAccess', _287 => _287.kind]) === _typescript2.default.SyntaxKind.PrefixUnaryExpression) {
          const op = parent.operator;
          if (op === _typescript2.default.SyntaxKind.PlusPlusToken || op === _typescript2.default.SyntaxKind.MinusMinusToken) {
            safe = false;
            return;
        ...
        if (_optionalChain([parent, 'optionalAccess', _288 => _288.kind]) === _typescript2.default.SyntaxKind.SpreadElement) {
          safe = false;
          return;
        }
        if (_optionalChain([parent, 'optionalAccess', _289 => _289.kind]) === _typescript2.default.SyntaxKind.ArrayLiteralExpression && _optionalChain([parent, 'access', _290 => _290.parent, 'optionalAccess', _291 => _291.kind]) === _typescript2.default.SyntaxKind.BinaryExpression && parent.parent.left === parent && parent.parent.operatorToken.kind === _typescript2.default.SyntaxKind.EqualsToken) {
          safe = false;
          return;
        }
        if (_optionalChain([parent, 'optionalAccess', _292 => _292.kind]) === _typescript2.default.SyntaxKind.BinaryExpression && parent.left === n) {
          const op = parent.operatorToken.kind;
          if (op === _typescript2.default.SyntaxKind.EqualsToken) {
  ...
  getGoLocalType(declaration, parsedValue) {
    ...
    const sourceName = _optionalChain([declaration, 'access', _293 => _293.name, 'optionalAccess', _294 => _294.escapedText]);
    if (sourceName === void 0) {
      return "any";
    }
...
`;
    ...
    if (_optionalChain([declaration, 'optionalAccess', _297 => _297.initializer, 'optionalAccess', _298 => _298.kind]) === _typescript2.default.SyntaxKind.AwaitExpression) {
...
${this.getIden(identation)}PanicOnError(${parsedName})`;
    ...
    if (_optionalChain([node, 'optionalAccess', _299 => _299.parent, 'optionalAccess', _300 => _300.kind]) === _typescript2.default.SyntaxKind.FirstStatement) {
      if (isNew) {
...
${this.getIden(identation)}PanicOnError(${varName})`;
  ...
  printConstructorDeclaration(node, identation) {
    ...
    let superCallParams = "";
    let hasSuperCall = false;
    _optionalChain([node, 'access', _301 => _301.body, 'optionalAccess', _302 => _302.statements, 'access', _303 => _303.forEach, 'call', _304 => _304((statement) => {
      if (_typescript2.default.isExpressionStatement(statement)) {
        const expression = statement.expression;
        if (_typescript2.default.isCallExpression(expression)) {
          const expressionText = expression.expression.getText().trim();
  ...
  printThisElementAccesssIfNeeded(node, identation) {
    const isAsync = true;
    const elementAccess = node.expression;
    if (_optionalChain([elementAccess, 'optionalAccess', _305 => _305.kind]) === _typescript2.default.SyntaxKind.ElementAccessExpression) {
      if (_optionalChain([elementAccess, 'optionalAccess', _306 => _306.expression, 'optionalAccess', _307 => _307.kind]) === _typescript2.default.SyntaxKind.ThisKeyword) {
        let parsedArg = _optionalChain([node, 'access', _308 => _308.arguments, 'optionalAccess', _309 => _309.length]) > 0 ? this.printNode(node.arguments[0], identation).trimStart() : "";
        const propName = this.printNode(elementAccess.argumentExpression, 0);
        const wrapperOpen = isAsync ? this.UKNOWN_PROP_ASYNC_WRAPPER_OPEN : this.UKNOWN_PROP_WRAPPER_OPEN;
        const wrapperClose = isAsync ? this.UNKOWN_PROP_ASYNC_WRAPPER_CLOSE : this.UNKOWN_PROP_WRAPPER_CLOSE;
        parsedArg = parsedArg ? ", " + parsedArg : "";
  ...
  printDynamicCall(node, identation) {
    const elementAccess = node.expression;
    if (_optionalChain([elementAccess, 'optionalAccess', _310 => _310.kind]) === _typescript2.default.SyntaxKind.ElementAccessExpression) {
      const argumentDepth = this.goExprDepth + (_optionalChain([node, 'access', _311 => _311.arguments, 'optionalAccess', _312 => _312.length]) > 0 ? 1 : 0);
      const parsedArg = _optionalChain([node, 'access', _313 => _313.arguments, 'optionalAccess', _314 => _314.length]) > 0 ? node.arguments.map((n) => this.goWithExprDepth(argumentDepth, () => this.printNode(n, identation).trimStart())).join(", ") : "";
  ...
  printWrappedUnknownThisProperty(node, identation = 0) {
    const type = this.getChecker().getResolvedSignature(node);
    if (_optionalChain([type, 'optionalAccess', _315 => _315.declaration]) === void 0) {
      const argumentDepth = this.goExprDepth + (_optionalChain([node, 'access', _316 => _316.arguments, 'optionalAccess', _317 => _317.length]) > 0 ? 1 : 0);
      let parsedArguments = _optionalChain([node, 'access', _318 => _318.arguments, 'optionalAccess', _319 => _319.map, 'call', _320 => _320((a) => this.goWithExprDepth(argumentDepth, () => this.printNode(a, identation).trimStart())), 'access', _321 => _321.join, 'call', _322 => _322(", ")]);
      parsedArguments = parsedArguments ? parsedArguments : "";
      const propName = _optionalChain([node, 'access', _323 => _323.expression, 'optionalAccess', _324 => _324.name, 'access', _325 => _325.escapedText]);
  ...
  printOutOfOrderCallExpressionIfAny(node, identation) {
    if (node.expression.kind === _typescript2.default.SyntaxKind.PropertyAccessExpression) {
      ...
      const leftSide = _optionalChain([node, 'access', _326 => _326.expression, 'optionalAccess', _327 => _327.expression]);
      const leftSideText = leftSide ? this.printNode(leftSide, 0) : void 0;
      if (leftSideText === this.THIS_TOKEN || leftSide.getFullText().indexOf("(this as any)") > -1) {
...
`;
  ...
  goScalarFamily(node) {
    if (_optionalChain([node, 'optionalAccess', _328 => _328.kind]) === _typescript2.default.SyntaxKind.Identifier && this.goDeclaredTypeOfIdentifier(node) === void 0) {
      let decl;
      try {
        decl = _optionalChain([this, 'access', _329 => _329.getChecker, 'call', _330 => _330(), 'access', _331 => _331.getSymbolAtLocation, 'call', _332 => _332(node), 'optionalAccess', _333 => _333.valueDeclaration]);
      } catch (e) {
        decl = void 0;
      }
  ...
  goIsAnyBoxExpression(node, printedText) {
    if (_optionalChain([node, 'optionalAccess', _334 => _334.kind]) === _typescript2.default.SyntaxKind.Identifier) {
      let symbol;
      try {
        symbol = this.getChecker().getSymbolAtLocation(node);
      } catch (e) {
      ...
      const decl = _optionalChain([symbol, 'optionalAccess', _335 => _335.valueDeclaration]);
      const isBinding = _optionalChain([decl, 'optionalAccess', _336 => _336.kind]) === _typescript2.default.SyntaxKind.Parameter || _optionalChain([decl, 'optionalAccess', _337 => _337.kind]) === _typescript2.default.SyntaxKind.VariableDeclaration;
      if (!isBinding) {
        return false;
      }
    ...
    if (_optionalChain([node, 'optionalAccess', _338 => _338.kind]) === _typescript2.default.SyntaxKind.CallExpression) {
  ...
  goAnyLocalHoldsPointer(decl) {
    if (_optionalChain([decl, 'optionalAccess', _339 => _339.kind]) !== _typescript2.default.SyntaxKind.VariableDeclaration || _optionalChain([decl, 'access', _340 => _340.name, 'optionalAccess', _341 => _341.kind]) !== _typescript2.default.SyntaxKind.Identifier) {
      return false;
    }
    ...
    const isPointerInit = (expr) => {
      while (_optionalChain([expr, 'optionalAccess', _342 => _342.kind]) === _typescript2.default.SyntaxKind.ParenthesizedExpression) {
        expr = expr.expression;
      }
      if (_optionalChain([expr, 'optionalAccess', _343 => _343.kind]) !== _typescript2.default.SyntaxKind.CallExpression) {
        return false;
      }
      const callee = expr.expression;
      if (_optionalChain([callee, 'optionalAccess', _344 => _344.kind]) !== _typescript2.default.SyntaxKind.PropertyAccessExpression || _optionalChain([callee, 'access', _345 => _345.expression, 'optionalAccess', _346 => _346.kind]) !== _typescript2.default.SyntaxKind.ThisKeyword) {
        return false;
      }
      const name = _optionalChain([callee, 'access', _347 => _347.name, 'optionalAccess', _348 => _348.escapedText]);
    ...
    if (!holds) {
      ...
      const visit = (n) => {
        ...
        if (n.kind === _typescript2.default.SyntaxKind.BinaryExpression && n.operatorToken.kind === _typescript2.default.SyntaxKind.EqualsToken && _optionalChain([n, 'access', _349 => _349.left, 'optionalAccess', _350 => _350.kind]) === _typescript2.default.SyntaxKind.Identifier && n.left.escapedText === name && isPointerInit(n.right)) {
          holds = true;
          return;
        }
        _typescript2.default.forEachChild(n, visit);
  ...
  goScalarFamilyOfType(type, allowNil = false) {
    ...
    const alias = _optionalChain([type, 'access', _351 => _351.aliasSymbol, 'optionalAccess', _352 => _352.escapedName]);
    if (!allowNil) {
      switch (alias) {
        case "Str":
        case "Int":
  ...
  goDeclaredTypeOfIdentifier(node) {
    if (_optionalChain([node, 'optionalAccess', _353 => _353.kind]) !== _typescript2.default.SyntaxKind.Identifier) {
      return void 0;
    }
    let symbol;
    try {
    ...
    const decl = _optionalChain([symbol, 'optionalAccess', _354 => _354.valueDeclaration]);
    if (decl === void 0 || decl.kind !== _typescript2.default.SyntaxKind.VariableDeclaration) {
      return void 0;
    }
    if (decl.initializer === void 0 || _optionalChain([decl, 'access', _355 => _355.name, 'optionalAccess', _356 => _356.kind]) !== _typescript2.default.SyntaxKind.Identifier) {
      return void 0;
    }
  ...
  goPointerTypeOfExpression(node, printedText) {
    ...
    if (_optionalChain([node, 'optionalAccess', _357 => _357.kind]) === _typescript2.default.SyntaxKind.CallExpression) {
      const goType = this.goTypeOfInitializer(node, printedText);
  ...
  goElementAssignmentContainerType(node, printedText) {
    ...
    if (_optionalChain([node, 'optionalAccess', _358 => _358.kind]) === _typescript2.default.SyntaxKind.CallExpression) {
  ...
  goSliceIndexProvablyInRange(node, indexNode) {
    if (_optionalChain([node, 'optionalAccess', _359 => _359.kind]) !== _typescript2.default.SyntaxKind.Identifier || _optionalChain([indexNode, 'optionalAccess', _360 => _360.kind]) !== _typescript2.default.SyntaxKind.NumericLiteral) {
      return false;
    }
    ...
    const decl = _optionalChain([symbol, 'optionalAccess', _361 => _361.valueDeclaration]);
    if (decl === void 0 || decl.kind !== _typescript2.default.SyntaxKind.VariableDeclaration || _optionalChain([decl, 'access', _362 => _362.name, 'optionalAccess', _363 => _363.kind]) !== _typescript2.default.SyntaxKind.Identifier) {
      return false;
    }
    const initializer = decl.initializer;
    if (_optionalChain([initializer, 'optionalAccess', _364 => _364.kind]) !== _typescript2.default.SyntaxKind.ArrayLiteralExpression) {
      return false;
    }
  ...
  goRebindingTargetOf(identifier) {
    let node = identifier;
    let parent = node.parent;
    while (_optionalChain([parent, 'optionalAccess', _365 => _365.kind]) === _typescript2.default.SyntaxKind.ArrayLiteralExpression) {
      node = parent;
      parent = parent.parent;
    }
    if (_optionalChain([parent, 'optionalAccess', _366 => _366.kind]) === _typescript2.default.SyntaxKind.ForOfStatement && parent.initializer === node) {
      return parent;
    }
    if (_optionalChain([parent, 'optionalAccess', _367 => _367.kind]) === _typescript2.default.SyntaxKind.BinaryExpression && parent.left === node) {
      const op = parent.operatorToken.kind;
  ...
  goPrintedTypeOfExpression(node, printedText) {
    const inner = _optionalChain([node, 'optionalAccess', _368 => _368.kind]) === _typescript2.default.SyntaxKind.ParenthesizedExpression ? node.expression : node;
    if (_optionalChain([inner, 'optionalAccess', _369 => _369.kind]) === _typescript2.default.SyntaxKind.Identifier) {
...
${this.getIden(level)}}()`;
  ...
  printInlineOpNeg(node, printedText) {
    ...
    if (/^\d+(\.\d+)?([eE][+-]?\d+)?$/.test(printedText.trim())) {
      ...
      const parent = node.parent;
      if (_optionalChain([parent, 'optionalAccess', _370 => _370.kind]) === _typescript2.default.SyntaxKind.CallExpression) {
        const callee = this.printNode(parent.expression, 0);
        if (this.comparisonHelpers.indexOf(callee) >= 0) {
          return `-${printedText}`;
        }
      }
      if (_optionalChain([parent, 'optionalAccess', _371 => _371.kind]) === _typescript2.default.SyntaxKind.BinaryExpression) {
        const op = parent.operatorToken.kind;
  ...
  printInlineTruthy(node) {
    if (_optionalChain([node, 'optionalAccess', _372 => _372.kind]) !== _typescript2.default.SyntaxKind.Identifier) {
      return void 0;
    }
    const goType = this.goDeclaredTypeOfIdentifier(node);
    if (goType === void 0) {
  ...
  goNativeCondition(node) {
    if (_optionalChain([node, 'optionalAccess', _373 => _373.kind]) === _typescript2.default.SyntaxKind.Identifier) {
      return this.printInlineTruthy(node);
    }
    if (_optionalChain([node, 'optionalAccess', _374 => _374.kind]) === _typescript2.default.SyntaxKind.ParenthesizedExpression) {
  ...
  goIsControlClauseCondition(node) {
    const parent = _optionalChain([node, 'optionalAccess', _375 => _375.parent]);
    switch (_optionalChain([parent, 'optionalAccess', _376 => _376.kind])) {
      case _typescript2.default.SyntaxKind.IfStatement:
      case _typescript2.default.SyntaxKind.WhileStatement:
  ...
  printCondition(node, identation) {
    ...
    const inNode = _optionalChain([node, 'optionalAccess', _377 => _377.kind]) === _typescript2.default.SyntaxKind.ParenthesizedExpression ? node.expression : node;
    if (_optionalChain([inNode, 'optionalAccess', _378 => _378.kind]) === _typescript2.default.SyntaxKind.BinaryExpression && inNode.operatorToken.kind === _typescript2.default.SyntaxKind.InKeyword) {
  ...
  goDerefComparableWith(ptrNode, ptrText, otherNode) {
    const pointee = _optionalChain([this, 'access', _379 => _379.goPointerTypeOfExpression, 'call', _380 => _380(ptrNode, ptrText), 'optionalAccess', _381 => _381.substring, 'call', _382 => _382(1)]);
    if (pointee === void 0) {
      return false;
    }
    switch (_optionalChain([otherNode, 'optionalAccess', _383 => _383.kind])) {
      case _typescript2.default.SyntaxKind.StringLiteral:
      case _typescript2.default.SyntaxKind.NoSubstitutionTemplateLiteral:
  ...
  printInlineEquality(left, right, leftText, rightText, isEq) {
    ...
    const lRepeatable = _optionalChain([left, 'optionalAccess', _384 => _384.kind]) === _typescript2.default.SyntaxKind.Identifier;
    const rRepeatable = _optionalChain([right, 'optionalAccess', _385 => _385.kind]) === _typescript2.default.SyntaxKind.Identifier;
    ...
    const isLiteral = (node) => {
      switch (_optionalChain([node, 'optionalAccess', _386 => _386.kind])) {
        case _typescript2.default.SyntaxKind.StringLiteral:
        case _typescript2.default.SyntaxKind.NoSubstitutionTemplateLiteral:
        case _typescript2.default.SyntaxKind.TrueKeyword:
        case _typescript2.default.SyntaxKind.FalseKeyword:
  ...
  goLiteralTypedLocalKind(node) {
    ...
    const declaration = _optionalChain([symbol, 'optionalAccess', _387 => _387.valueDeclaration]);
    if (_optionalChain([declaration, 'optionalAccess', _388 => _388.kind]) !== _typescript2.default.SyntaxKind.VariableDeclaration || declaration.initializer === void 0) {
      return void 0;
    }
    const declarationList = declaration.parent;
    if (_optionalChain([declarationList, 'optionalAccess', _389 => _389.kind]) !== _typescript2.default.SyntaxKind.VariableDeclarationList || _optionalChain([declarationList, 'access', _390 => _390.parent, 'optionalAccess', _391 => _391.kind]) === _typescript2.default.SyntaxKind.FirstStatement) {
      return void 0;
    }
  ...
  goNumericLiteralKind(node) {
    const text = _optionalChain([node, 'optionalAccess', _392 => _392.text]);
    if (text === void 0) {
      return void 0;
    }
  ...
  goLiteralFitsKind(node, kind) {
    const value = Number(_optionalChain([node, 'optionalAccess', _393 => _393.text, 'optionalAccess', _394 => _394.replaceAll, 'call', _395 => _395("_", "")]));
  ...
  goComparisonKind(left, leftKind, right, rightKind) {
    ...
    if (_optionalChain([left, 'optionalAccess', _396 => _396.kind]) === _typescript2.default.SyntaxKind.NumericLiteral && _optionalChain([right, 'optionalAccess', _397 => _397.kind]) !== _typescript2.default.SyntaxKind.NumericLiteral) {
      return this.goLiteralFitsKind(left, rightKind) ? rightKind : void 0;
    }
    if (_optionalChain([right, 'optionalAccess', _398 => _398.kind]) === _typescript2.default.SyntaxKind.NumericLiteral && _optionalChain([left, 'optionalAccess', _399 => _399.kind]) !== _typescript2.default.SyntaxKind.NumericLiteral) {
  ...
  printParenthesizedExpression(node, identation) {
    const expression = node.expression;
    if (_optionalChain([expression, 'optionalAccess', _400 => _400.kind]) === _typescript2.default.SyntaxKind.AsExpression) {
      return this.getIden(identation) + this.printNode(expression, 0);
    }
    if (_optionalChain([expression, 'optionalAccess', _401 => _401.kind]) === _typescript2.default.SyntaxKind.ArrowFunction) {
      return "";
    }
  ...
  printExpressionStatement(node, identation) {
    if (_optionalChain([node, 'optionalAccess', _402 => _402.expression, 'optionalAccess', _403 => _403.kind]) === _typescript2.default.SyntaxKind.AsExpression) {
...
${this.getIden(identation)}PanicOnError(${returnRandName})`;
  ...
  printReturnStatement(node, identation) {
    ...
    if (_optionalChain([node, 'optionalAccess', _404 => _404.expression, 'optionalAccess', _405 => _405.kind]) === _typescript2.default.SyntaxKind.AsExpression) {
      node = node.expression;
    }
    if (_optionalChain([node, 'optionalAccess', _406 => _406.expression, 'optionalAccess', _407 => _407.kind]) === _typescript2.default.SyntaxKind.AwaitExpression) {
...
${this.getIden(identation)}${returnStatement}`;
  ...
  goPrintCallArgument(argument, printedText) {
    if (_optionalChain([argument, 'optionalAccess', _408 => _408.kind]) !== _typescript2.default.SyntaxKind.BinaryExpression || printedText === void 0) {
      return printedText;
    }
  ...
  printArrayPushCall(node, identation, name = void 0, parsedArg = void 0) {
    ...
    parsedArg = this.goPrintCallArgument(_optionalChain([node, 'access', _409 => _409.arguments, 'optionalAccess', _410 => _410[0]]), parsedArg);
    if (_optionalChain([name, 'optionalAccess', _411 => _411.startsWith, 'call', _412 => _412("GetValue")]) || /[\]\)]$/.test(_nullishCoalesce(name, () => ( "")))) {
...
${this.getIden(identation)}`;
  ...
  printSliceCall(node, identation, name = void 0, parsedArg = void 0, parsedArg2 = void 0) {
    parsedArg = this.goPrintCallArgument(_optionalChain([node, 'access', _413 => _413.arguments, 'optionalAccess', _414 => _414[0]]), parsedArg);
    parsedArg2 = this.goPrintCallArgument(_optionalChain([node, 'access', _415 => _415.arguments, 'optionalAccess', _416 => _416[1]]), parsedArg2);
    if (parsedArg2 === void 0) {
      parsedArg2 = "nil";
    }
    return `Slice(${name}, ${parsedArg}, ${parsedArg2})`;
  ...
  printThrowStatement(node, identation) {
    ...
    if (node.expression.kind === _typescript2.default.SyntaxKind.NewExpression) {
      const expression = node.expression;
      const argumentsExp = _nullishCoalesce(_optionalChain([expression, 'optionalAccess', _417 => _417.arguments]), () => ( []));
      const parsedArg = _nullishCoalesce(argumentsExp.map((n) => this.printNode(n, 0)).join(","), () => ( ""));
      const newExpression = this.printNode(expression.expression, 0);
      if (expression.expression.kind === _typescript2.default.SyntaxKind.Identifier) {
        const id = expression.expression;
        const symbol = this.getChecker().getSymbolAtLocation(expression.expression);
        if (symbol) {
          const declarations = _nullishCoalesce(_optionalChain([this, 'access', _418 => _418.getChecker, 'call', _419 => _419(), 'access', _420 => _420.getDeclaredTypeOfSymbol, 'call', _421 => _421(symbol), 'access', _422 => _422.symbol, 'optionalAccess', _423 => _423.declarations]), () => ( []));
          const isClassDeclaration = declarations.find((l) => l.kind === _typescript2.default.SyntaxKind.InterfaceDeclaration || l.kind === _typescript2.default.SyntaxKind.ClassDeclaration);
          if (isClassDeclaration) {
          } else {
...
${this.getIden(identation)}return nil`;
  ...
  printBinaryExpression(node, identation) {
    ...
    if (operatorToken.kind === _typescript2.default.SyntaxKind.EqualsToken) {
      ...
      if (_optionalChain([right, 'optionalAccess', _424 => _424.kind]) === _typescript2.default.SyntaxKind.AwaitExpression || rightSide.startsWith("<-this.callInternal")) {
        const leftParsed = this.printNode(left, 0);
        const awaited = _optionalChain([right, 'optionalAccess', _425 => _425.kind]) === _typescript2.default.SyntaxKind.AwaitExpression ? this.printNode(right, identation) : rightSide;
        return `
...
${tryBodyBlock}
  ...
  printNewExpression(node, identation) {
    let expression = _optionalChain([node, 'access', _426 => _426.expression, 'optionalAccess', _427 => _427.escapedText]);
    expression = expression ? expression : this.printNode(node.expression);
  ...
  isGoThisPropertyAccessExpression(node) {
    return _optionalChain([node, 'optionalAccess', _428 => _428.kind]) === _typescript2.default.SyntaxKind.PropertyAccessExpression && _optionalChain([node, 'access', _429 => _429.expression, 'optionalAccess', _430 => _430.kind]) === _typescript2.default.SyntaxKind.ThisKeyword;
  }
  ...
  isGoElementAccessAssignmentTarget(node) {
    const parent = node.parent;
    return _optionalChain([parent, 'optionalAccess', _431 => _431.kind]) === _typescript2.default.SyntaxKind.BinaryExpression && parent.left === node && (parent.operatorToken.kind === _typescript2.default.SyntaxKind.EqualsToken || parent.operatorToken.kind === _typescript2.default.SyntaxKind.PlusEqualsToken);
  }
  printElementAccessExpression(node, identation) {
...
var JavaTranspiler = class extends BaseTranspiler {
  ...
  countRequiredParameters(declaration) {
    const params = _nullishCoalesce(_optionalChain([declaration, 'optionalAccess', _432 => _432.parameters]), () => ( []));
    let required = 0;
  ...
  printArgsForCallExpression(node, identation) {
    ...
    const isThisCall = _optionalChain([callee, 'optionalAccess', _433 => _433.kind]) === _typescript2.default.SyntaxKind.PropertyAccessExpression && _optionalChain([callee, 'access', _434 => _434.expression, 'optionalAccess', _435 => _435.kind]) === _typescript2.default.SyntaxKind.ThisKeyword;
    if (isThisCall && args.length > 0) {
      ...
      if (isNullish) {
        ...
        const declaration = _optionalChain([signature, 'optionalAccess', _436 => _436.declaration]);
        if (declaration !== void 0) {
  ...
  printIdentifier(node) {
    ...
    const isInsideNewExpression = _optionalChain([node, 'optionalAccess', _437 => _437.parent, 'optionalAccess', _438 => _438.kind]) === _typescript2.default.SyntaxKind.NewExpression;
    const isInsideCatch = _optionalChain([node, 'optionalAccess', _439 => _439.parent, 'optionalAccess', _440 => _440.kind]) === _typescript2.default.SyntaxKind.ThrowStatement;
    const isLeftSide = _optionalChain([node, 'optionalAccess', _441 => _441.parent, 'optionalAccess', _442 => _442.name]) === node || _optionalChain([node, 'optionalAccess', _443 => _443.parent, 'optionalAccess', _444 => _444.left]) === node;
    const isCallOrPropertyAccess = _optionalChain([node, 'optionalAccess', _445 => _445.parent, 'optionalAccess', _446 => _446.kind]) === _typescript2.default.SyntaxKind.PropertyAccessExpression || _optionalChain([node, 'optionalAccess', _447 => _447.parent, 'optionalAccess', _448 => _448.kind]) === _typescript2.default.SyntaxKind.ElementAccessExpression;
    if (!isLeftSide && !isCallOrPropertyAccess && !isInsideCatch && !isInsideNewExpression) {
      const type = this.getChecker().getTypeAtLocation(node);
      const typeSymbol = _optionalChain([type, 'optionalAccess', _449 => _449.symbol]);
      if (typeSymbol !== void 0) {
        const decl = _nullishCoalesce(_optionalChain([typeSymbol, 'optionalAccess', _450 => _450.declarations]), () => ( []));
        let isBuiltIn = void 0;
        if (decl.length > 0) {
          isBuiltIn = decl[0].getSourceFile().fileName.indexOf("typescript") > -1;
        }
        if (isBuiltIn !== void 0 && !isBuiltIn) {
          ...
          if (symbol) {
            ...
            if (first.kind === _typescript2.default.SyntaxKind.ImportSpecifier) {
              ...
              if (_optionalChain([importedSymbol, 'optionalAccess', _451 => _451.declarations, 'access', _452 => _452[0], 'optionalAccess', _453 => _453.kind]) === _typescript2.default.SyntaxKind.ClassDeclaration) {
                isClassDeclaration = true;
              }
            }
          }
  ...
  printConstructorDeclaration(node, identation) {
    ...
    let superCallParams = "";
    let hasSuperCall = false;
    _optionalChain([node, 'access', _454 => _454.body, 'optionalAccess', _455 => _455.statements, 'access', _456 => _456.forEach, 'call', _457 => _457((statement) => {
      if (_typescript2.default.isExpressionStatement(statement)) {
        const expression = statement.expression;
        if (_typescript2.default.isCallExpression(expression)) {
          const expressionText = expression.expression.getText().trim();
  ...
  printDynamicCall(node, identation) {
    const elementAccess = node.expression;
    if (_optionalChain([elementAccess, 'optionalAccess', _458 => _458.kind]) === _typescript2.default.SyntaxKind.ElementAccessExpression) {
      const parsedArg = _optionalChain([node, 'access', _459 => _459.arguments, 'optionalAccess', _460 => _460.length]) > 0 ? node.arguments.map((n) => this.printNode(n, identation).trimStart()).join(", ") : "";
      const target = this.printNode(elementAccess.expression, 0);
      const propName = this.printNode(elementAccess.argumentExpression, 0);
      const argsArray = `new Object[] { ${parsedArg} }`;
      const open = this.DYNAMIC_CALL_OPEN;
  ...
  getExpressionStatementPrefixesIfAny(node, identation) {
    const finalVars = [];
    if (_optionalChain([node, 'access', _461 => _461.expression, 'optionalAccess', _462 => _462.kind]) === _typescript2.default.SyntaxKind.CallExpression) {
  ...
  printWrappedUnknownThisProperty(node) {
    const type = this.getChecker().getResolvedSignature(node);
    if (_optionalChain([type, 'optionalAccess', _463 => _463.declaration]) === void 0) {
      let parsedArguments = _optionalChain([node, 'access', _464 => _464.arguments, 'optionalAccess', _465 => _465.map, 'call', _466 => _466((a) => this.printNode(a, 0)), 'access', _467 => _467.join, 'call', _468 => _468(", ")]);
      parsedArguments = parsedArguments ? parsedArguments : "";
      const propName = _optionalChain([node, 'access', _469 => _469.expression, 'optionalAccess', _470 => _470.name, 'access', _471 => _471.escapedText]);
      const isAsyncDecl = _optionalChain([node, 'optionalAccess', _472 => _472.parent, 'optionalAccess', _473 => _473.kind]) === _typescript2.default.SyntaxKind.AwaitExpression;
      const argsArray = `new Object[] { ${parsedArguments} }`;
      const open = this.DYNAMIC_CALL_OPEN;
  ...
  printOutOfOrderCallExpressionIfAny(node, identation) {
    if (node.expression.kind === _typescript2.default.SyntaxKind.PropertyAccessExpression) {
      ...
      const leftSide = _optionalChain([node, 'access', _474 => _474.expression, 'optionalAccess', _475 => _475.expression]);
      const leftSideText = leftSide ? this.printNode(leftSide, 0) : void 0;
      if (leftSideText === this.THIS_TOKEN || leftSide.getFullText().indexOf("(this as any)") > -1) {
        const res = this.printWrappedUnknownThisProperty(node);
        if (res)
  ...
  getVarMethodIfAny(node) {
    let current = _optionalChain([node, 'optionalAccess', _476 => _476.parent]);
    while (current) {
      if (_typescript2.default.isMethodDeclaration(current) || _typescript2.default.isFunctionDeclaration(current)) {
        return String(_nullishCoalesce(_optionalChain([current, 'access', _477 => _477.name, 'optionalAccess', _478 => _478.escapedText]), () => ( "")));
      }
      current = current.parent;
    }
  ...
  getVarClassIfAny(node) {
    let current = _optionalChain([node, 'optionalAccess', _479 => _479.parent]);
    while (current) {
      if (_typescript2.default.isClassDeclaration(current)) {
        return String(_nullishCoalesce(_optionalChain([current, 'access', _480 => _480.name, 'optionalAccess', _481 => _481.escapedText]), () => ( "")));
      }
      current = current.parent;
    }
    return "";
  ...
  getVarKey(node) {
    const varName = _nullishCoalesce(_optionalChain([node, 'optionalAccess', _482 => _482.escapedText]), () => ( _optionalChain([node, 'optionalAccess', _483 => _483.name, 'optionalAccess', _484 => _484.escapedText])));
    if (!varName) {
      return "";
    }
  ...
  isNullishLiteral(node) {
    return _optionalChain([node, 'optionalAccess', _485 => _485.kind]) === _typescript2.default.SyntaxKind.NullKeyword || _optionalChain([node, 'optionalAccess', _486 => _486.kind]) === _typescript2.default.SyntaxKind.Identifier && node.escapedText === "undefined";
  }
  ...
  printNativeEqualityIfProvable(node, leftText, rightText) {
    ...
    const checker = this.getChecker();
    const leftFamily = this.equalityOperandFamily(_optionalChain([checker, 'optionalAccess', _487 => _487.getTypeAtLocation, 'call', _488 => _488(node.left)]));
    const rightFamily = this.equalityOperandFamily(_optionalChain([checker, 'optionalAccess', _489 => _489.getTypeAtLocation, 'call', _490 => _490(node.right)]));
  ...
  isVarargsArrayReference(node, depth = 0) {
    ...
    const symbol = this.getChecker().getSymbolAtLocation(node);
    const declaration = _nullishCoalesce(_optionalChain([symbol, 'optionalAccess', _491 => _491.valueDeclaration]), () => ( _optionalChain([symbol, 'optionalAccess', _492 => _492.declarations, 'optionalAccess', _493 => _493[0]])));
    if (!declaration) {
      return false;
    }
  ...
  isJavaListType(type) {
    ...
    return _optionalChain([type, 'access', _494 => _494.target, 'optionalAccess', _495 => _495.symbol, 'optionalAccess', _496 => _496.escapedName]) === "ReadonlyArray";
  }
  ...
  isJavaPrimitiveForCounter(node) {
    ...
    if (!incrementor || _optionalChain([incrementor, 'access', _497 => _497.operand, 'optionalAccess', _498 => _498.kind]) !== _typescript2.default.SyntaxKind.Identifier || incrementor.operand.escapedText !== node.escapedText) {
      return false;
    }
  ...
  isJavaMapType(type) {
    ...
    const declarations = _nullishCoalesce(_optionalChain([type, 'access', _499 => _499.getSymbol, 'call', _500 => _500(), 'optionalAccess', _501 => _501.declarations]), () => ( []));
...
`;
  ...
  isJavaMapStructureType(type) {
    ...
    const declaration = _optionalChain([symbol, 'optionalAccess', _502 => _502.declarations, 'optionalAccess', _503 => _503[0]]);
    const fileName = _optionalChain([declaration, 'optionalAccess', _504 => _504.getSourceFile, 'optionalCall', _505 => _505(), 'optionalAccess', _506 => _506.fileName]);
  ...
  tupleRequiredElementCount(type) {
    const flags = _nullishCoalesce(_nullishCoalesce(_optionalChain([type, 'optionalAccess', _507 => _507.target, 'optionalAccess', _508 => _508.elementFlags]), () => ( _optionalChain([type, 'optionalAccess', _509 => _509.elementFlags]))), () => ( []));
    let required = 0;
  ...
  isLeftSideOfAssignment(node) {
    const parent = node.parent;
    if (_optionalChain([parent, 'optionalAccess', _510 => _510.kind]) !== _typescript2.default.SyntaxKind.BinaryExpression || parent.left !== node) {
      return false;
    }
  ...
  javaNativeConcat(node) {
    if (_optionalChain([node, 'optionalAccess', _511 => _511.operatorToken, 'optionalAccess', _512 => _512.kind]) !== _typescript2.default.SyntaxKind.PlusToken) {
      return false;
    }
  ...
  javaNativeArithmeticKind(node) {
    const op = _optionalChain([node, 'optionalAccess', _513 => _513.operatorToken, 'optionalAccess', _514 => _514.kind]);
  ...
  getObjectLiteralFromCallExpressionArguments(node) {
    const res = [];
    if (!_optionalChain([node, 'optionalAccess', _515 => _515.arguments])) {
      return res;
    }
    const args = node.arguments;
  ...
  getBinaryExpressionPrefixes(node, identation) {
    let right = _optionalChain([node, 'optionalAccess', _516 => _516.right]);
    if (_optionalChain([right, 'optionalAccess', _517 => _517.kind]) === _typescript2.default.SyntaxKind.AwaitExpression) {
  ...
  analyzeFinalVars(fnBody) {
    ...
    const symbolIdOf = (n) => {
      try {
        const checker = this.getChecker();
        const sym = _optionalChain([checker, 'optionalAccess', _518 => _518.getSymbolAtLocation, 'optionalCall', _519 => _519(n)]);
        const decl = _nullishCoalesce(_optionalChain([sym, 'optionalAccess', _520 => _520.declarations, 'optionalAccess', _521 => _521[0]]), () => ( _optionalChain([sym, 'optionalAccess', _522 => _522.valueDeclaration])));
        if (decl)
    ...
    const discoverPotentialReassignments = (node) => {
      if (!node)
        return;
      if (node.kind === _typescript2.default.SyntaxKind.BinaryExpression) {
        if (_optionalChain([node, 'access', _523 => _523.left, 'optionalAccess', _524 => _524.kind]) === _typescript2.default.SyntaxKind.Identifier) {
          reassignedSyms.add(symbolIdOf(node.left));
        } else if (node.operatorToken.kind === _typescript2.default.SyntaxKind.EqualsToken && _optionalChain([node, 'access', _525 => _525.left, 'optionalAccess', _526 => _526.kind]) === _typescript2.default.SyntaxKind.ArrayLiteralExpression) {
          for (const elem of _nullishCoalesce(node.left.elements, () => ( []))) {
            if (_optionalChain([elem, 'optionalAccess', _527 => _527.kind]) === _typescript2.default.SyntaxKind.Identifier) {
              reassignedSyms.add(symbolIdOf(elem));
            }
          }
        }
      }
      if ((node.kind === _typescript2.default.SyntaxKind.PrefixUnaryExpression || node.kind === _typescript2.default.SyntaxKind.PostfixUnaryExpression) && this.isIncDecOperator(node.operator) && _optionalChain([node, 'access', _528 => _528.operand, 'optionalAccess', _529 => _529.kind]) === _typescript2.default.SyntaxKind.Identifier) {
        reassignedSyms.add(symbolIdOf(node.operand));
      }
      if (node.kind === _typescript2.default.SyntaxKind.Identifier) {
        const name = node.escapedText;
        if (name && name !== "undefined" && !_optionalChain([name, 'access', _530 => _530.startsWith, 'optionalCall', _531 => _531("null")])) {
    ...
    const visitExprInObjLit = (n) => {
      ...
      if (n.kind === _typescript2.default.SyntaxKind.Identifier) {
        ...
        if (name && name !== "undefined" && !_optionalChain([name, 'access', _532 => _532.startsWith, 'optionalCall', _533 => _533("null")])) {
      ...
      if (n.kind === _typescript2.default.SyntaxKind.CallExpression) {
        _optionalChain([n, 'access', _534 => _534.arguments, 'optionalAccess', _535 => _535.forEach, 'call', _536 => _536(visitExprInObjLit)]);
        if (_optionalChain([n, 'access', _537 => _537.expression, 'optionalAccess', _538 => _538.kind]) === _typescript2.default.SyntaxKind.PropertyAccessExpression) {
      ...
      if (n.kind === _typescript2.default.SyntaxKind.ElementAccessExpression) {
        ...
        while (_optionalChain([left, 'optionalAccess', _539 => _539.kind]) === _typescript2.default.SyntaxKind.ElementAccessExpression) {
      ...
      if (n.kind === _typescript2.default.SyntaxKind.ObjectLiteralExpression) {
        _optionalChain([n, 'access', _540 => _540.properties, 'optionalAccess', _541 => _541.forEach, 'call', _542 => _542((p) => {
          if (p.initializer)
    ...
    const walk = (node) => {
      ...
      if (node.kind === _typescript2.default.SyntaxKind.BinaryExpression && this.isAssignmentOperator(node.operatorToken.kind)) {
        walk(node.right);
        if (_optionalChain([node, 'access', _543 => _543.left, 'optionalAccess', _544 => _544.kind]) === _typescript2.default.SyntaxKind.Identifier) {
      ...
      if ((node.kind === _typescript2.default.SyntaxKind.PrefixUnaryExpression || node.kind === _typescript2.default.SyntaxKind.PostfixUnaryExpression) && this.isIncDecOperator(node.operator) && _optionalChain([node, 'access', _545 => _545.operand, 'optionalAccess', _546 => _546.kind]) === _typescript2.default.SyntaxKind.Identifier) {
      ...
      if (node.kind === _typescript2.default.SyntaxKind.ObjectLiteralExpression) {
        _optionalChain([node, 'access', _547 => _547.properties, 'optionalAccess', _548 => _548.forEach, 'call', _549 => _549((prop) => {
          if (prop.initializer) {
      ...
      if (node.kind === _typescript2.default.SyntaxKind.TryStatement) {
        ...
        walkBlockAndBump(_optionalChain([node, 'access', _550 => _550.catchClause, 'optionalAccess', _551 => _551.block]));
  ...
  getObjectLiteralId(node) {
    ...
    const fileName = _nullishCoalesce(_optionalChain([node, 'access', _552 => _552.getSourceFile, 'optionalCall', _553 => _553(), 'optionalAccess', _554 => _554.fileName]), () => ( ""));
  ...
  printVariableDeclarationList(node, identation) {
    ...
    if (this.removeVariableDeclarationForFunctionExpression && _optionalChain([declaration, 'optionalAccess', _555 => _555.initializer]) && _typescript2.default.isFunctionExpression(declaration.initializer)) {
      return this.printNode(declaration.initializer, identation).trimEnd();
    }
    if (_optionalChain([declaration, 'optionalAccess', _556 => _556.name, 'access', _557 => _557.kind]) === _typescript2.default.SyntaxKind.ArrayBindingPattern) {
      const arrayBindingPattern = declaration.name;
      const arrayBindingPatternElements = arrayBindingPattern.elements;
...
`;
    ...
    const isNew = _optionalChain([declaration, 'optionalAccess', _558 => _558.initializer]) && declaration.initializer.kind === _typescript2.default.SyntaxKind.NewExpression;
    const varToken = isNew ? "var " : this.VAR_TOKEN + " ";
    if (!declaration.initializer) {
      return this.getIden(identation) + "Object " + this.printNode(declaration.name) + " = " + this.UNDEFINED_TOKEN;
    }
  ...
  printThisKeyword(node, identation) {
    let current = _optionalChain([node, 'optionalAccess', _559 => _559.parent]);
    while (current) {
      ...
      current = _optionalChain([current, 'optionalAccess', _560 => _560.parent]);
    }
    return this.THIS_TOKEN;
  }
  transformPropertyAcessExpressionIfNeeded(node) {
  ...
  printCustomDefaultValueIfNeeded(node) {
    ...
    if (_optionalChain([node, 'optionalAccess', _561 => _561.escapedText]) === "undefined" && _optionalChain([this, 'access', _562 => _562.getChecker, 'call', _563 => _563(), 'access', _564 => _564.getTypeAtLocation, 'call', _565 => _565(_optionalChain([node, 'optionalAccess', _566 => _566.parent])), 'optionalAccess', _567 => _567.flags]) === _typescript2.default.TypeFlags.Number) {
      return this.UNDEFINED_TOKEN;
    }
    return void 0;
  }
  ...
  isPureInitializer(node) {
    switch (_optionalChain([node, 'optionalAccess', _568 => _568.kind])) {
      case _typescript2.default.SyntaxKind.NullKeyword:
      case _typescript2.default.SyntaxKind.TrueKeyword:
      case _typescript2.default.SyntaxKind.FalseKeyword:
      case _typescript2.default.SyntaxKind.StringLiteral:
...
`;
  ...
  printFinalOutsideMethodVariableWrappersIfAny(node, identation) {
    const parameters = _optionalChain([node, 'optionalAccess', _569 => _569.parameters]);
  ...
  printInsideMethodVariableWrappersIfAny(node, identation) {
    const parameters = _optionalChain([node, 'optionalAccess', _570 => _570.parameters]);
    const finalVarWrappers = [];
    if (parameters) {
      const isAsyncMethod = this.isAsyncFunction(node);
      parameters.forEach((param) => {
  ...
  printReplaceAllCall(node, identation, name = void 0, parsedArg = void 0, parsedArg2 = void 0) {
    const pattern = this.stringLiteralArgument(_optionalChain([node, 'optionalAccess', _571 => _571.arguments, 'optionalAccess', _572 => _572[0]]));
    const replacement = this.stringLiteralArgument(_optionalChain([node, 'optionalAccess', _573 => _573.arguments, 'optionalAccess', _574 => _574[1]]));
    const receiver = this.sideEffectFreeReceiver(_optionalChain([node, 'optionalAccess', _575 => _575.expression]));
  ...
  printThrowStatement(node, identation) {
    ...
    if (node.expression.kind === _typescript2.default.SyntaxKind.NewExpression) {
      const expression = node.expression;
      const argumentsExp = _nullishCoalesce(_optionalChain([expression, 'optionalAccess', _576 => _576.arguments]), () => ( []));
      const parsedArg = _nullishCoalesce(argumentsExp.map((n) => this.printNode(n, 0)).join(","), () => ( ""));
      const newExpression = this.printNode(expression.expression, 0);
      if (expression.expression.kind === _typescript2.default.SyntaxKind.Identifier) {
        const id = expression.expression;
        ...
        const symbol = this.getChecker().getSymbolAtLocation(expression.expression);
        if (symbol) {
          const declarations = _nullishCoalesce(_optionalChain([this, 'access', _577 => _577.getChecker, 'call', _578 => _578(), 'access', _579 => _579.getDeclaredTypeOfSymbol, 'call', _580 => _580(symbol), 'access', _581 => _581.symbol, 'optionalAccess', _582 => _582.declarations]), () => ( []));
...
var _RustTranspiler = class _RustTranspiler extends BaseTranspiler {
  ...
  printVariableDeclarationList(node, identation) {
    ...
    if (_optionalChain([declaration, 'optionalAccess', _583 => _583.name, 'access', _584 => _584.kind]) === SyntaxKind4.ArrayBindingPattern) {
...
`;
  ...
  rustNodeIsBoolExpression(node) {
    switch (_optionalChain([node, 'optionalAccess', _585 => _585.kind])) {
      case SyntaxKind4.TrueKeyword:
      case SyntaxKind4.FalseKeyword:
        return true;
      case SyntaxKind4.ParenthesizedExpression:
  ...
  rustEnclosingFunction(node) {
    let current = _optionalChain([node, 'optionalAccess', _586 => _586.parent]);
    while (current) {
      switch (current.kind) {
  ...
  rustBindsName(node, name) {
    switch (_optionalChain([node, 'optionalAccess', _587 => _587.kind])) {
      ...
      case SyntaxKind4.FunctionExpression:
      case SyntaxKind4.ArrowFunction:
        return _optionalChain([node, 'access', _588 => _588.name, 'optionalAccess', _589 => _589.kind]) === SyntaxKind4.Identifier && node.name.escapedText === name;
    }
    return false;
  }
  ...
  getRustBoolLocalInitializer(declaration, printedValue) {
    const initializer = declaration.initializer;
    if (initializer === void 0 || _optionalChain([declaration, 'access', _590 => _590.name, 'optionalAccess', _591 => _591.kind]) !== SyntaxKind4.Identifier) {
      return void 0;
    }
...
${classMethods}
  ...
  printFunctionDefinition(node, identation) {
    const name = _nullishCoalesce(_optionalChain([node, 'access', _592 => _592.name, 'optionalAccess', _593 => _593.escapedText]), () => ( ""));
    const params = node.parameters;
  ...
  printNewExpression(node, identation) {
    let expression = _optionalChain([node, 'access', _594 => _594.expression, 'optionalAccess', _595 => _595.escapedText]);
    expression = expression ? expression : this.printNode(node.expression);
  ...
  typeSymbolOf(type) {
    if (type === void 0 || type === null)
      return void 0;
    return _nullishCoalesce(_nullishCoalesce(_optionalChain([type, 'access', _596 => _596.getSymbol, 'optionalCall', _597 => _597()]), () => ( type.symbol)), () => ( type.aliasSymbol));
  }
  ...
  isLibDeclaredType(type) {
    const declarations = _nullishCoalesce(_optionalChain([this, 'access', _598 => _598.typeSymbolOf, 'call', _599 => _599(type), 'optionalAccess', _600 => _600.declarations]), () => ( []));
    return declarations.some((d) => {
      const file = _nullishCoalesce(_optionalChain([d, 'optionalAccess', _601 => _601.getSourceFile, 'optionalCall', _602 => _602(), 'optionalAccess', _603 => _603.fileName]), () => ( ""));
  ...
  isClassInstanceType(type) {
    ...
    if (_optionalChain([symbol, 'optionalAccess', _604 => _604.flags]) & _typescript2.default.SymbolFlags.Class)
      return true;
    const declarations = _nullishCoalesce(_optionalChain([symbol, 'optionalAccess', _605 => _605.declarations]), () => ( []));
  ...
  isProvenListType(type) {
    if (!(type.flags & _typescript2.default.TypeFlags.Object))
      return false;
    const objectFlags = (_nullishCoalesce(type.objectFlags, () => ( 0))) | (_nullishCoalesce(_optionalChain([type, 'access', _606 => _606.target, 'optionalAccess', _607 => _607.objectFlags]), () => ( 0)));
    if (objectFlags & _typescript2.default.ObjectFlags.Tuple)
      return true;
    const name = _optionalChain([this, 'access', _608 => _608.typeSymbolOf, 'call', _609 => _609(type), 'optionalAccess', _610 => _610.getName, 'optionalCall', _611 => _611()]);
    if (name === "Array" || name === "ReadonlyArray")
      return true;
    const targetName = _optionalChain([this, 'access', _612 => _612.typeSymbolOf, 'call', _613 => _613(type.target), 'optionalAccess', _614 => _614.getName, 'optionalCall', _615 => _615()]);
...
${idn}}`;
  ...
  printIfStatement(node, identation) {
    ...
    const elseStatement = node.elseStatement;
    if (_optionalChain([elseStatement, 'optionalAccess', _616 => _616.kind]) === SyntaxKind4.Block) {
      ifComplete += ` else${this.printBlock(elseStatement, identation)}`;
    } else if (_optionalChain([elseStatement, 'optionalAccess', _617 => _617.kind]) === SyntaxKind4.IfStatement) {
...
${this.getIden(identation)}})`;
  ...
  printIncludesCall(node, identation, name = void 0, parsedArg = void 0) {
    const pRef = _optionalChain([parsedArg, 'optionalAccess', _618 => _618.startsWith, 'call', _619 => _619("Value::")]) ? `&${parsedArg}` : `&${parsedArg}`;
  ...
  printTryStatement(node, identation) {
    ...
    const catchBody = node.catchClause.block.statements.map((s) => this.printNode(s, identation + 1)).join("\n");
    const rawName = _optionalChain([node, 'access', _620 => _620.catchClause, 'optionalAccess', _621 => _621.variableDeclaration, 'optionalAccess', _622 => _622.name, 'optionalAccess', _623 => _623.escapedText]);
...
var CppTranspiler = class extends BaseTranspiler {
  ...
  printConstructorDeclaration(node, identation) {
    ...
    let superCallParams = "";
    let hasSuperCall = false;
    _optionalChain([node, 'access', _624 => _624.body, 'optionalAccess', _625 => _625.statements, 'access', _626 => _626.forEach, 'call', _627 => _627((statement) => {
      if (_typescript2.default.isExpressionStatement(statement)) {
        const expression = statement.expression;
        if (_typescript2.default.isCallExpression(expression)) {
          const expressionText = expression.expression.getText().trim();
...
`;
  ...
  printVariableDeclarationList(node, identation) {
    const declaration = node.declarations[0];
    if (_optionalChain([declaration, 'optionalAccess', _628 => _628.name, 'access', _629 => _629.kind]) === _typescript2.default.SyntaxKind.ArrayBindingPattern) {
      const arrayBindingPattern = declaration.name;
      const arrayBindingPatternElements = arrayBindingPattern.elements;
      const parsedArrayBindingElements = arrayBindingPatternElements.map((e) => this.printNode(e.name, 0));
      const syntheticName = parsedArrayBindingElements.join("") + "Variable";
...
`;
  ...
  printThrowStatement(node, identation) {
    ...
    if (node.expression.kind === _typescript2.default.SyntaxKind.NewExpression) {
      const expression = node.expression;
      const argumentsExp = _nullishCoalesce(_optionalChain([expression, 'optionalAccess', _630 => _630.arguments]), () => ( []));
      const parsedArg = _nullishCoalesce(argumentsExp.map((n) => this.printNode(n, 0)).join(", "), () => ( ""));
      const newExpression = this.printNode(expression.expression, 0);
      if (expression.expression.kind === _typescript2.default.SyntaxKind.Identifier) {
        const id = expression.expression;
        const symbol = this.getChecker().getSymbolAtLocation(expression.expression);
        if (symbol) {
          const declarations = _nullishCoalesce(_optionalChain([this, 'access', _631 => _631.getChecker, 'call', _632 => _632(), 'access', _633 => _633.getDeclaredTypeOfSymbol, 'call', _634 => _634(symbol), 'access', _635 => _635.symbol, 'optionalAccess', _636 => _636.declarations]), () => ( []));
          const isClassDeclaration = declarations.find((l) => l.kind === _typescript2.default.SyntaxKind.InterfaceDeclaration || l.kind === _typescript2.default.SyntaxKind.ClassDeclaration);
          if (isClassDeclaration) {
...
function getProgramAndTypeCheckerFromMemory(rootDir, text, options = {}, cache) {
  ...
  const program = _typescript2.default.createProgram({
    ...
    host,
    oldProgram: _optionalChain([cache, 'optionalAccess', _637 => _637.memoryOldProgram])
  });
  if (cache !== void 0) {
