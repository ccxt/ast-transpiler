...
`;
  ...
  javaStringElementsReceiver(node) {
    ...
    const declaration = _optionalChain([this, 'access', _455 => _455.getChecker, 'call', _456 => _456(), 'access', _457 => _457.getSymbolAtLocation, 'call', _458 => _458(node), 'optionalAccess', _459 => _459.valueDeclaration]);
    ...
    if (_typescript2.default.isCallExpression(initializer) && _typescript2.default.isPropertyAccessExpression(initializer.expression)) {
      return _optionalChain([initializer, 'access', _460 => _460.expression, 'access', _461 => _461.name, 'optionalAccess', _462 => _462.escapedText]) === "split";
    }
    if (_typescript2.default.isArrayLiteralExpression(initializer)) {
