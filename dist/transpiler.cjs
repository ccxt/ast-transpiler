...
var CSharpTranspiler = class extends BaseTranspiler {
  ...
  csharpDictionaryElementWriteTarget(node) {
    const parent = _optionalChain([node, 'optionalAccess', _85 => _85.parent]);
    const isWrite = _optionalChain([parent, 'optionalAccess', _86 => _86.kind]) === _typescript2.default.SyntaxKind.BinaryExpression && parent.operatorToken.kind === _typescript2.default.SyntaxKind.EqualsToken && parent.left === node;
  ...
  csharpNativeElementAccess(node) {
    ...
    const isWrite = _optionalChain([parent, 'optionalAccess', _87 => _87.kind]) === _typescript2.default.SyntaxKind.BinaryExpression && (parent.operatorToken.kind === _typescript2.default.SyntaxKind.EqualsToken || parent.operatorToken.kind === _typescript2.default.SyntaxKind.PlusEqualsToken) && parent.left === node;
    if (isWrite) {
      return void 0;
    }
  ...
  csharpLiteralDeclaresKey(node, expression, key, isNumberKey) {
    ...
    const declarations = _nullishCoalesce(_optionalChain([symbol, 'optionalAccess', _88 => _88.declarations]), () => ( []));
  ...
  csharpElementAccessReceiverIsList(node) {
    if (_optionalChain([node, 'optionalAccess', _89 => _89.kind]) !== _typescript2.default.SyntaxKind.ElementAccessExpression) {
      return false;
    }
    const parent = node.parent;
    if (_optionalChain([parent, 'optionalAccess', _90 => _90.kind]) !== _typescript2.default.SyntaxKind.BinaryExpression || _optionalChain([parent, 'access', _91 => _91.operatorToken, 'optionalAccess', _92 => _92.kind]) !== _typescript2.default.SyntaxKind.EqualsToken || parent.left !== node) {
      return false;
    }
    const receiver = node.expression;
    if (_optionalChain([receiver, 'optionalAccess', _93 => _93.kind]) !== _typescript2.default.SyntaxKind.Identifier) {
      return false;
    }
  ...
  csharpListIndexRead(node) {
    if (_optionalChain([node, 'optionalAccess', _94 => _94.kind]) !== _typescript2.default.SyntaxKind.ElementAccessExpression) {
      return void 0;
    }
    const { expression, argumentExpression } = node;
    if (_optionalChain([expression, 'optionalAccess', _95 => _95.kind]) !== _typescript2.default.SyntaxKind.Identifier || _optionalChain([argumentExpression, 'optionalAccess', _96 => _96.kind]) !== _typescript2.default.SyntaxKind.Identifier) {
      return void 0;
    }
    const parent = node.parent;
    const isWrite = _optionalChain([parent, 'optionalAccess', _97 => _97.kind]) === _typescript2.default.SyntaxKind.BinaryExpression && (parent.operatorToken.kind === _typescript2.default.SyntaxKind.EqualsToken || parent.operatorToken.kind === _typescript2.default.SyntaxKind.PlusEqualsToken) && parent.left === node;
    if (isWrite) {
      return void 0;
    }
    const types = typeof this.csharpListIndexReadTypes === "function" ? this.csharpListIndexReadTypes(node) : void 0;
    if (_optionalChain([types, 'optionalAccess', _98 => _98.index]) !== "int") {
      return void 0;
    }
  ...
  csharpIndexIsLoopBounded(read, receiver, index) {
    ...
    let node = read;
    while (_optionalChain([node, 'optionalAccess', _99 => _99.parent]) !== void 0) {
      const parent = node.parent;
  ...
  csharpIdentifierSymbol(node) {
    if (_optionalChain([node, 'optionalAccess', _100 => _100.kind]) !== _typescript2.default.SyntaxKind.Identifier) {
      return void 0;
    }
    try {
  ...
  csharpForBoundsIndex(forStatement, read, receiverSymbol, indexSymbol) {
    ...
    if (_optionalChain([condition, 'optionalAccess', _101 => _101.kind]) !== _typescript2.default.SyntaxKind.BinaryExpression || _optionalChain([condition, 'access', _102 => _102.operatorToken, 'optionalAccess', _103 => _103.kind]) !== _typescript2.default.SyntaxKind.LessThanToken) {
      return false;
    }
    const length = condition.right;
    if (_optionalChain([length, 'optionalAccess', _104 => _104.kind]) !== _typescript2.default.SyntaxKind.PropertyAccessExpression || _optionalChain([length, 'access', _105 => _105.name, 'optionalAccess', _106 => _106.escapedText]) !== "length") {
      return false;
    }
  ...
  csharpReceiverUseKeepsBound(node) {
    ...
    if (parent.kind === _typescript2.default.SyntaxKind.PropertyAccessExpression && parent.expression === node) {
      ...
      return !(_optionalChain([grand, 'optionalAccess', _107 => _107.kind]) === _typescript2.default.SyntaxKind.CallExpression && grand.expression === parent);
    }
    return false;
  }
  ...
  csharpIdentifierIsWritten(node) {
    ...
    if (parent.kind === _typescript2.default.SyntaxKind.ArrayLiteralExpression || parent.kind === _typescript2.default.SyntaxKind.PropertyAccessExpression) {
      const grand = parent.parent;
      return _optionalChain([grand, 'optionalAccess', _108 => _108.kind]) === _typescript2.default.SyntaxKind.BinaryExpression && grand.left === parent && this.csharpIsAssignmentOperator(grand.operatorToken.kind);
    }
    return false;
  }
  ...
  printTypedDictElementAccessIfAny(node) {
    ...
    const parent = node.parent;
    const isLeftSideOfAssignment = _optionalChain([parent, 'optionalAccess', _109 => _109.kind]) === _typescript2.default.SyntaxKind.BinaryExpression && (parent.operatorToken.kind === _typescript2.default.SyntaxKind.EqualsToken || parent.operatorToken.kind === _typescript2.default.SyntaxKind.PlusEqualsToken) && parent.left === node;
  ...
  printWrappedUnknownThisProperty(node) {
    ...
    if (_optionalChain([type, 'optionalAccess', _110 => _110.declaration]) === void 0) {
      let parsedArguments = _optionalChain([node, 'access', _111 => _111.arguments, 'optionalAccess', _112 => _112.map, 'call', _113 => _113((a) => this.printNode(a, 0)), 'access', _114 => _114.join, 'call', _115 => _115(", ")]);
      parsedArguments = parsedArguments ? parsedArguments : "";
      const propName = _optionalChain([node, 'access', _116 => _116.expression, 'optionalAccess', _117 => _117.name, 'access', _118 => _118.escapedText]);
      const isAsyncDecl = _optionalChain([node, 'optionalAccess', _119 => _119.parent, 'optionalAccess', _120 => _120.kind]) === _typescript2.default.SyntaxKind.AwaitExpression;
  ...
  printOutOfOrderCallExpressionIfAny(node, identation) {
    if (node.expression.kind === _typescript2.default.SyntaxKind.PropertyAccessExpression) {
      ...
      const leftSide = _optionalChain([node, 'access', _121 => _121.expression, 'optionalAccess', _122 => _122.expression]);
  ...
  csharpDeclaredTypeOfBinding(node) {
    ...
    const declaration = _optionalChain([symbol, 'optionalAccess', _123 => _123.valueDeclaration]);
  ...
  csharpOperandsAreNumbers(node) {
    const isNumber = (operand) => {
      let flags;
      try {
        flags = _optionalChain([this, 'access', _124 => _124.getChecker, 'call', _125 => _125(), 'access', _126 => _126.getTypeAtLocation, 'call', _127 => _127(operand), 'optionalAccess', _128 => _128.flags]);
      } catch (e) {
        return false;
      }
  ...
  csharpNativeReceiver(node) {
    if (_optionalChain([node, 'optionalAccess', _129 => _129.kind]) === _typescript2.default.SyntaxKind.ParenthesizedExpression) {
    ...
    if (_typescript2.default.isPropertyAccessExpression(node) && _optionalChain([node, 'access', _130 => _130.expression, 'optionalAccess', _131 => _131.kind]) === _typescript2.default.SyntaxKind.ThisKeyword) {
      const name = _optionalChain([node, 'access', _132 => _132.name, 'optionalAccess', _133 => _133.escapedText]);
  ...
  csharpTypedLocalType(node) {
    const declaration = _optionalChain([this, 'access', _134 => _134.getChecker, 'call', _135 => _135(), 'access', _136 => _136.getSymbolAtLocation, 'call', _137 => _137(node), 'optionalAccess', _138 => _138.valueDeclaration]);
  ...
  csharpNativeStringKey(key) {
    if (_optionalChain([key, 'optionalAccess', _139 => _139.kind]) === _typescript2.default.SyntaxKind.ParenthesizedExpression) {
  ...
  csharpIsArrayType(type) {
    ...
    return _optionalChain([type, 'optionalAccess', _140 => _140.symbol, 'optionalAccess', _141 => _141.escapedName]) === "Array";
  }
  ...
  csharpStringLiteralEquality(op, left, right, leftText, rightText) {
    ...
    if (_optionalChain([operand, 'optionalAccess', _142 => _142.kind]) !== _typescript2.default.SyntaxKind.Identifier) {
      return void 0;
    }
...
`;
  ...
  csharpCallReturnType(initializer) {
    if (_optionalChain([initializer, 'optionalAccess', _143 => _143.kind]) === _typescript2.default.SyntaxKind.PropertyAccessExpression) {
      return _optionalChain([initializer, 'access', _144 => _144.name, 'optionalAccess', _145 => _145.escapedText]) === "length" ? "int" : void 0;
    }
    if (_optionalChain([initializer, 'optionalAccess', _146 => _146.kind]) !== _typescript2.default.SyntaxKind.CallExpression) {
      return void 0;
    }
    const expression = initializer.expression;
    if (_optionalChain([expression, 'optionalAccess', _147 => _147.kind]) !== _typescript2.default.SyntaxKind.PropertyAccessExpression) {
      return void 0;
    }
    const methodName = _optionalChain([expression, 'access', _148 => _148.name, 'optionalAccess', _149 => _149.escapedText]);
    const target = expression.expression;
    if (_optionalChain([target, 'optionalAccess', _150 => _150.kind]) === _typescript2.default.SyntaxKind.ThisKeyword) {
      if (!this.csharpCalleeResolves(initializer)) {
        return void 0;
      }
      return CSHARP_THIS_RETURN_TYPES[methodName];
    }
    if (_optionalChain([target, 'optionalAccess', _151 => _151.kind]) === _typescript2.default.SyntaxKind.Identifier) {
  ...
  csharpCalleeResolves(node) {
    ...
    return _optionalChain([signature, 'optionalAccess', _152 => _152.declaration]) !== void 0;
  }
  ...
  csharpLocalIsSafeToType(scope, declaration, varName, csharpType, safeAccessor = false) {
    ...
    const visit = (n) => {
      ...
      if (n.kind === _typescript2.default.SyntaxKind.Identifier && n.escapedText === varName && n !== declaration.name) {
        const parent = n.parent;
        if (_optionalChain([parent, 'optionalAccess', _157 => _157.kind]) === _typescript2.default.SyntaxKind.VariableDeclaration && parent.name === n) {
          return;
        }
        if (_optionalChain([parent, 'optionalAccess', _158 => _158.kind]) === _typescript2.default.SyntaxKind.PostfixUnaryExpression || _optionalChain([parent, 'optionalAccess', _159 => _159.kind]) === _typescript2.default.SyntaxKind.PrefixUnaryExpression) {
        ...
        if (_optionalChain([parent, 'optionalAccess', _160 => _160.kind]) === _typescript2.default.SyntaxKind.SpreadElement) {
          safe = false;
          return;
        }
        if (_optionalChain([parent, 'optionalAccess', _161 => _161.kind]) === _typescript2.default.SyntaxKind.ArrayLiteralExpression && _optionalChain([parent, 'access', _162 => _162.parent, 'optionalAccess', _163 => _163.kind]) === _typescript2.default.SyntaxKind.BinaryExpression && parent.parent.left === parent && parent.parent.operatorToken.kind === _typescript2.default.SyntaxKind.EqualsToken) {
          safe = false;
          return;
        }
        if (_optionalChain([parent, 'optionalAccess', _164 => _164.kind]) === _typescript2.default.SyntaxKind.PropertyAccessExpression && parent.expression === n) {
          const method = _optionalChain([parent, 'access', _165 => _165.name, 'optionalAccess', _166 => _166.escapedText]);
        ...
        if (safeAccessor) {
          if (_optionalChain([parent, 'optionalAccess', _167 => _167.kind]) === _typescript2.default.SyntaxKind.VariableDeclaration && _optionalChain([parent, 'access', _168 => _168.name, 'optionalAccess', _169 => _169.kind]) === _typescript2.default.SyntaxKind.ArrayBindingPattern && !this.csharpTypeIsList(csharpType)) {
            safe = false;
            return;
          }
        ...
        if (_optionalChain([parent, 'optionalAccess', _170 => _170.kind]) === _typescript2.default.SyntaxKind.BinaryExpression && parent.left === n) {
  ...
  getCSharpLocalType(declaration) {
    ...
    const sourceName = _optionalChain([declaration, 'access', _171 => _171.name, 'optionalAccess', _172 => _172.escapedText]);
  ...
  csharpIsSafeAccessorCall(initializer) {
    if (_optionalChain([initializer, 'optionalAccess', _173 => _173.kind]) !== _typescript2.default.SyntaxKind.CallExpression) {
      return false;
    }
    const expression = initializer.expression;
    if (_optionalChain([expression, 'optionalAccess', _174 => _174.kind]) !== _typescript2.default.SyntaxKind.PropertyAccessExpression || _optionalChain([expression, 'access', _175 => _175.expression, 'optionalAccess', _176 => _176.kind]) !== _typescript2.default.SyntaxKind.ThisKeyword) {
      return false;
    }
    return CSHARP_SAFE_ACCESSOR_NAMES.indexOf(_optionalChain([expression, 'access', _177 => _177.name, 'optionalAccess', _178 => _178.escapedText])) >= 0;
  }
  ...
  csharpIsClassThrowArgument(node) {
    ...
    while (current.parent) {
      ...
      if (parent.kind === _typescript2.default.SyntaxKind.NewExpression && _optionalChain([parent, 'access', _179 => _179.arguments, 'optionalAccess', _180 => _180.indexOf, 'call', _181 => _181(current)]) >= 0) {
        current = parent;
        continue;
      }
  ...
  csharpIsDeleteKey(node) {
    ...
    return _optionalChain([access, 'optionalAccess', _182 => _182.kind]) === _typescript2.default.SyntaxKind.ElementAccessExpression && access.argumentExpression === value && _optionalChain([access, 'access', _183 => _183.parent, 'optionalAccess', _184 => _184.kind]) === _typescript2.default.SyntaxKind.DeleteExpression;
  }
  ...
  csharpIsLeftPlusOperand(node) {
    ...
    if (_optionalChain([parent, 'optionalAccess', _185 => _185.kind]) !== _typescript2.default.SyntaxKind.BinaryExpression || parent.left !== value) {
      return false;
    }
    const op = parent.operatorToken.kind;
  ...
  csharpReceiverBinding(receiver) {
    if (_optionalChain([receiver, 'optionalAccess', _186 => _186.kind]) !== _typescript2.default.SyntaxKind.Identifier) {
      return void 0;
    }
    const symbol = this.getChecker().getSymbolAtLocation(receiver);
    return _optionalChain([symbol, 'optionalAccess', _187 => _187.valueDeclaration]);
  }
  ...
  csharpStringReceiverType(receiver) {
    ...
    if (_optionalChain([declaration, 'optionalAccess', _188 => _188.kind]) !== _typescript2.default.SyntaxKind.VariableDeclaration) {
      return void 0;
    }
    if (_optionalChain([declaration, 'access', _189 => _189.parent, 'optionalAccess', _190 => _190.declarations, 'optionalAccess', _191 => _191.length]) !== 1) {
      return void 0;
    }
  ...
  csharpStringMethodReceiver(node, name) {
    const expression = _optionalChain([node, 'optionalAccess', _192 => _192.expression]);
    const receiver = _optionalChain([node, 'optionalAccess', _193 => _193.kind]) === _typescript2.default.SyntaxKind.CallExpression ? _optionalChain([expression, 'optionalAccess', _194 => _194.kind]) === _typescript2.default.SyntaxKind.PropertyAccessExpression ? expression.expression : void 0 : expression;
  ...
  csharpConditionOperandType(node) {
    if (_optionalChain([node, 'optionalAccess', _195 => _195.kind]) !== _typescript2.default.SyntaxKind.Identifier) {
      return void 0;
    }
    const symbol = this.getChecker().getSymbolAtLocation(node);
    const declaration = _optionalChain([symbol, 'optionalAccess', _196 => _196.valueDeclaration]);
    if (_optionalChain([declaration, 'optionalAccess', _197 => _197.kind]) !== _typescript2.default.SyntaxKind.VariableDeclaration) {
      return void 0;
    }
    if (_optionalChain([declaration, 'access', _198 => _198.parent, 'optionalAccess', _199 => _199.declarations, 'optionalAccess', _200 => _200.length]) !== 1) {
      return void 0;
    }
  ...
  csharpNativeCondition(node, identation) {
    ...
    const parent = node.parent;
    const negated = _optionalChain([parent, 'optionalAccess', _201 => _201.kind]) === _typescript2.default.SyntaxKind.PrefixUnaryExpression && parent.operator === _typescript2.default.SyntaxKind.ExclamationToken;
  ...
  csharpConditionPositionAllowsNative(node) {
    const parent = _optionalChain([node, 'optionalAccess', _202 => _202.parent]);
    switch (_optionalChain([parent, 'optionalAccess', _203 => _203.kind])) {
      case _typescript2.default.SyntaxKind.IfStatement:
      ...
      case _typescript2.default.SyntaxKind.BinaryExpression: {
        const op = _optionalChain([parent, 'access', _204 => _204.operatorToken, 'optionalAccess', _205 => _205.kind]);
  ...
  printVariableDeclarationList(node, identation) {
    const declaration = node.declarations[0];
    if (this.removeVariableDeclarationForFunctionExpression && _optionalChain([declaration, 'optionalAccess', _206 => _206.initializer]) && _typescript2.default.isFunctionExpression(declaration.initializer)) {
      return this.printNode(declaration.initializer, identation).trimEnd();
    }
    if (_optionalChain([declaration, 'optionalAccess', _207 => _207.name, 'access', _208 => _208.kind]) === _typescript2.default.SyntaxKind.ArrayBindingPattern) {
...
`;
    ...
    const isNew = _optionalChain([declaration, 'optionalAccess', _209 => _209.initializer]) && declaration.initializer.kind === _typescript2.default.SyntaxKind.NewExpression;
    const varToken = isNew ? "var " : this.VAR_TOKEN + " ";
    if (_optionalChain([declaration, 'optionalAccess', _210 => _210.initializer]) && declaration.initializer === void 0) {
  ...
  printCustomDefaultValueIfNeeded(node) {
    ...
    if (_optionalChain([node, 'optionalAccess', _211 => _211.escapedText]) === "undefined" && _optionalChain([this, 'access', _212 => _212.getChecker, 'call', _213 => _213(), 'access', _214 => _214.getTypeAtLocation, 'call', _215 => _215(_optionalChain([node, 'optionalAccess', _216 => _216.parent])), 'optionalAccess', _217 => _217.flags]) === _typescript2.default.TypeFlags.Number) {
      return this.UNDEFINED_TOKEN;
    }
    return void 0;
  }
  ...
  csharpBooleanReturnType(node) {
    if (_optionalChain([node, 'optionalAccess', _218 => _218.kind]) !== _typescript2.default.SyntaxKind.MethodDeclaration || this.isAsyncFunction(node)) {
      return void 0;
    }
  ...
  printArrayPushCall(node, identation, name = void 0, parsedArg = void 0) {
    if (this.csharpReceiverIsDeclaredList(_optionalChain([node, 'optionalAccess', _219 => _219.expression, 'optionalAccess', _220 => _220.expression]))) {
  ...
  csharpReceiverIsDeclaredList(receiver) {
    if (_optionalChain([receiver, 'optionalAccess', _221 => _221.kind]) !== _typescript2.default.SyntaxKind.Identifier) {
      return false;
    }
  ...
  csharpConditionPrintsBool(node) {
    switch (_optionalChain([node, 'optionalAccess', _222 => _222.kind])) {
      case _typescript2.default.SyntaxKind.TrueKeyword:
      case _typescript2.default.SyntaxKind.FalseKeyword:
        return true;
      case _typescript2.default.SyntaxKind.ParenthesizedExpression:
  ...
  csharpIsCheckedBoolean(node) {
    const type = this.getChecker().getTypeAtLocation(node);
    return ((_nullishCoalesce(_optionalChain([type, 'optionalAccess', _223 => _223.flags]), () => ( 0))) & _typescript2.default.TypeFlags.BooleanLike) !== 0;
  }
  ...
  csharpIdentifierPrintsBool(node) {
    ...
    if (declaration === void 0 || !_typescript2.default.isVariableDeclaration(declaration) || _optionalChain([declaration, 'access', _229 => _229.name, 'optionalAccess', _230 => _230.kind]) !== _typescript2.default.SyntaxKind.Identifier) {
      return false;
    }
  ...
  printCondition(node, identation) {
    ...
    if (_optionalChain([node, 'optionalAccess', _231 => _231.kind]) === _typescript2.default.SyntaxKind.PrefixUnaryExpression && node.operator === _typescript2.default.SyntaxKind.ExclamationToken) {
      return this.printPrefixUnaryExpression(node, identation);
    }
  ...
  csharpConditionParensIfNeeded(node, printed) {
    if (_optionalChain([node, 'optionalAccess', _232 => _232.kind]) !== _typescript2.default.SyntaxKind.BinaryExpression) {
      return printed;
    }
    const op = node.operatorToken.kind;
    ...
    const parent = node.parent;
    const underNot = _optionalChain([parent, 'optionalAccess', _233 => _233.kind]) === _typescript2.default.SyntaxKind.PrefixUnaryExpression && parent.operator === _typescript2.default.SyntaxKind.ExclamationToken;
    const underAnd = op === _typescript2.default.SyntaxKind.BarBarToken && _optionalChain([parent, 'optionalAccess', _234 => _234.kind]) === _typescript2.default.SyntaxKind.BinaryExpression && parent.operatorToken.kind === _typescript2.default.SyntaxKind.AmpersandAmpersandToken;
  ...
  csharpConditionPrintsAsBool(node) {
    if (_optionalChain([node, 'optionalAccess', _235 => _235.kind]) !== _typescript2.default.SyntaxKind.Identifier) {
      return false;
    }
    const checker = this.getChecker();
    const declaration = _optionalChain([checker, 'access', _236 => _236.getSymbolAtLocation, 'call', _237 => _237(node), 'optionalAccess', _238 => _238.valueDeclaration]);
    if (_optionalChain([declaration, 'optionalAccess', _239 => _239.kind]) !== _typescript2.default.SyntaxKind.VariableDeclaration) {
      return false;
    }
  ...
  printNewExpression(node, identation) {
    let expression = _optionalChain([node, 'access', _240 => _240.expression, 'optionalAccess', _241 => _241.escapedText]);
    expression = expression ? expression : this.printNode(node.expression);
    if (expression === "Error") {
      expression = "Exception";
    }
  ...
  printThrowStatement(node, identation) {
    ...
    if (node.expression.kind === _typescript2.default.SyntaxKind.NewExpression) {
      const expression = node.expression;
      const argumentsExp = _nullishCoalesce(_optionalChain([expression, 'optionalAccess', _242 => _242.arguments]), () => ( []));
      ...
      if (expression.expression.kind === _typescript2.default.SyntaxKind.Identifier) {
        ...
        if (symbol) {
          const declarations = _nullishCoalesce(_optionalChain([this, 'access', _243 => _243.getChecker, 'call', _244 => _244(), 'access', _245 => _245.getDeclaredTypeOfSymbol, 'call', _246 => _246(symbol), 'access', _247 => _247.symbol, 'optionalAccess', _248 => _248.declarations]), () => ( []));
...
var GoTranspiler = class extends BaseTranspiler {
  ...
  printStruct(node, indentation) {
    const rows = [];
    if (_optionalChain([node, 'optionalAccess', _249 => _249.heritageClauses, 'optionalAccess', _250 => _250.length]) > 0) {
...
`;
  ...
  getAsyncBodyName(node, goName) {
    ...
    try {
      const parent = _optionalChain([node, 'optionalAccess', _251 => _251.parent]);
      if (parent && _typescript2.default.isClassDeclaration(parent)) {
        parent.members.forEach((member) => remember(_optionalChain([member, 'optionalAccess', _252 => _252.name, 'optionalAccess', _253 => _253.escapedText])));
        ...
        parent.statements.forEach((statement) => {
          if (_typescript2.default.isFunctionDeclaration(statement)) {
            remember(_optionalChain([statement, 'optionalAccess', _254 => _254.name, 'optionalAccess', _255 => _255.escapedText]));
          }
        });
      }
    } catch (e3) {
  ...
  printAsyncTrampolineArgs(node) {
    ...
    (_nullishCoalesce(_optionalChain([node, 'optionalAccess', _256 => _256.parameters]), () => ( []))).forEach((param) => {
  ...
  applyAsyncSuffixToCallee(nameNode, goName) {
    ...
    try {
      ...
      decls = _optionalChain([symbol, 'optionalAccess', _257 => _257.declarations]);
    } catch (e4) {
      return goName;
    }
  ...
  goTypeOfInitializer(initializer, printedValue) {
    switch (_optionalChain([initializer, 'optionalAccess', _258 => _258.kind])) {
      case _typescript2.default.SyntaxKind.StringLiteral:
      case _typescript2.default.SyntaxKind.NoSubstitutionTemplateLiteral:
        return "string";
      case _typescript2.default.SyntaxKind.TrueKeyword:
  ...
  goLocalStaticType(node) {
    const declaration = _optionalChain([this, 'access', _259 => _259.getChecker, 'call', _260 => _260(), 'access', _261 => _261.getSymbolAtLocation, 'call', _262 => _262(node), 'optionalAccess', _263 => _263.valueDeclaration]);
    if (_optionalChain([declaration, 'optionalAccess', _264 => _264.kind]) !== _typescript2.default.SyntaxKind.VariableDeclaration || declaration.initializer === void 0) {
      return void 0;
    }
    if (_optionalChain([declaration, 'access', _265 => _265.parent, 'optionalAccess', _266 => _266.parent, 'optionalAccess', _267 => _267.kind]) !== _typescript2.default.SyntaxKind.FirstStatement) {
      return void 0;
    }
  ...
  goOperandStaticType(node, printedText) {
    switch (_optionalChain([node, 'optionalAccess', _268 => _268.kind])) {
      case _typescript2.default.SyntaxKind.StringLiteral:
      case _typescript2.default.SyntaxKind.NoSubstitutionTemplateLiteral:
        return "string";
      case _typescript2.default.SyntaxKind.NumericLiteral:
      ...
      case _typescript2.default.SyntaxKind.BinaryExpression:
        return _optionalChain([this, 'access', _269 => _269.goNativeArithmetic, 'call', _270 => _270(node), 'optionalAccess', _271 => _271.goType]);
      case _typescript2.default.SyntaxKind.Identifier:
  ...
  isNonZeroIntegerLiteral(node) {
    if (_optionalChain([node, 'optionalAccess', _272 => _272.kind]) === _typescript2.default.SyntaxKind.ParenthesizedExpression) {
      return this.isNonZeroIntegerLiteral(node.expression);
    }
    return _optionalChain([node, 'optionalAccess', _273 => _273.kind]) === _typescript2.default.SyntaxKind.NumericLiteral && /^[1-9][0-9]*$/.test(node.text);
  }
  ...
  goNativeOperandText(node, printedText) {
    ...
    if (_optionalChain([node, 'optionalAccess', _274 => _274.kind]) !== _typescript2.default.SyntaxKind.BinaryExpression || text.startsWith("(")) {
      return text;
    }
  ...
  goNativeBinaryText(node, symbol, leftText, rightText) {
    const operandText = (operand, printed) => {
      const isBinary = _optionalChain([operand, 'optionalAccess', _275 => _275.kind]) === _typescript2.default.SyntaxKind.BinaryExpression;
  ...
  goEnclosingFunction(node) {
    let current = _optionalChain([node, 'optionalAccess', _276 => _276.parent]);
    while (current) {
      switch (current.kind) {
        case _typescript2.default.SyntaxKind.MethodDeclaration:
        case _typescript2.default.SyntaxKind.FunctionDeclaration:
  ...
  goTypeNameIsShadowed(scope, goType) {
    ...
    const visit = (n) => {
      ...
      const isBinding = n.kind === _typescript2.default.SyntaxKind.Parameter || n.kind === _typescript2.default.SyntaxKind.VariableDeclaration;
      if (isBinding && _optionalChain([n, 'access', _277 => _277.name, 'optionalAccess', _278 => _278.kind]) === _typescript2.default.SyntaxKind.Identifier) {
  ...
  goLocalIsSafeToType(scope, declaration, varName, goType) {
    ...
    const visit = (n) => {
      ...
      if (n.kind === _typescript2.default.SyntaxKind.Identifier && n.escapedText === varName && n !== declaration.name) {
        const parent = n.parent;
        if (_optionalChain([parent, 'optionalAccess', _279 => _279.kind]) === _typescript2.default.SyntaxKind.PropertyAccessExpression && parent.expression === n && _optionalChain([parent, 'access', _280 => _280.name, 'optionalAccess', _281 => _281.escapedText]) === "push") {
          safe = false;
          return;
        }
        if (_optionalChain([parent, 'optionalAccess', _282 => _282.kind]) === _typescript2.default.SyntaxKind.VariableDeclaration && parent.name === n) {
          return;
        }
        if (_optionalChain([parent, 'optionalAccess', _283 => _283.kind]) === _typescript2.default.SyntaxKind.PostfixUnaryExpression || _optionalChain([parent, 'optionalAccess', _284 => _284.kind]) === _typescript2.default.SyntaxKind.PrefixUnaryExpression) {
          const op = parent.operator;
          if (op === _typescript2.default.SyntaxKind.PlusPlusToken || op === _typescript2.default.SyntaxKind.MinusMinusToken) {
            safe = false;
            return;
        ...
        if (_optionalChain([parent, 'optionalAccess', _285 => _285.kind]) === _typescript2.default.SyntaxKind.SpreadElement) {
          safe = false;
          return;
        }
        if (_optionalChain([parent, 'optionalAccess', _286 => _286.kind]) === _typescript2.default.SyntaxKind.ArrayLiteralExpression && _optionalChain([parent, 'access', _287 => _287.parent, 'optionalAccess', _288 => _288.kind]) === _typescript2.default.SyntaxKind.BinaryExpression && parent.parent.left === parent && parent.parent.operatorToken.kind === _typescript2.default.SyntaxKind.EqualsToken) {
          safe = false;
          return;
        }
        if (_optionalChain([parent, 'optionalAccess', _289 => _289.kind]) === _typescript2.default.SyntaxKind.BinaryExpression && parent.left === n) {
          const op = parent.operatorToken.kind;
          if (op === _typescript2.default.SyntaxKind.EqualsToken) {
  ...
  getGoLocalType(declaration, parsedValue) {
    ...
    const sourceName = _optionalChain([declaration, 'access', _290 => _290.name, 'optionalAccess', _291 => _291.escapedText]);
    if (sourceName === void 0) {
      return "any";
    }
  ...
  printVariableDeclarationList(node, identation) {
    const declaration = node.declarations[0];
    if (_optionalChain([declaration, 'optionalAccess', _292 => _292.name, 'access', _293 => _293.kind]) === _typescript2.default.SyntaxKind.ArrayBindingPattern) {
      const arrayBindingPattern = declaration.name;
      const arrayBindingPatternElements = arrayBindingPattern.elements;
      const parsedArrayBindingElements = arrayBindingPatternElements.map((e) => this.printNode(e.name, 0));
      const syntheticName = parsedArrayBindingElements.join("") + "Variable";
...
`;
    ...
    if (_optionalChain([declaration, 'optionalAccess', _294 => _294.initializer, 'optionalAccess', _295 => _295.kind]) === _typescript2.default.SyntaxKind.AwaitExpression) {
...
${this.getIden(identation)}PanicOnError(${parsedName})`;
    ...
    if (_optionalChain([node, 'optionalAccess', _296 => _296.parent, 'optionalAccess', _297 => _297.kind]) === _typescript2.default.SyntaxKind.FirstStatement) {
      if (isNew) {
...
${this.getIden(identation)}PanicOnError(${varName})`;
  ...
  printConstructorDeclaration(node, identation) {
    ...
    let superCallParams = "";
    let hasSuperCall = false;
    _optionalChain([node, 'access', _298 => _298.body, 'optionalAccess', _299 => _299.statements, 'access', _300 => _300.forEach, 'call', _301 => _301((statement) => {
      if (_typescript2.default.isExpressionStatement(statement)) {
        const expression = statement.expression;
        if (_typescript2.default.isCallExpression(expression)) {
          const expressionText = expression.expression.getText().trim();
  ...
  printThisElementAccesssIfNeeded(node, identation) {
    const isAsync = true;
    const elementAccess = node.expression;
    if (_optionalChain([elementAccess, 'optionalAccess', _302 => _302.kind]) === _typescript2.default.SyntaxKind.ElementAccessExpression) {
      if (_optionalChain([elementAccess, 'optionalAccess', _303 => _303.expression, 'optionalAccess', _304 => _304.kind]) === _typescript2.default.SyntaxKind.ThisKeyword) {
        let parsedArg = _optionalChain([node, 'access', _305 => _305.arguments, 'optionalAccess', _306 => _306.length]) > 0 ? this.printNode(node.arguments[0], identation).trimStart() : "";
        const propName = this.printNode(elementAccess.argumentExpression, 0);
        const wrapperOpen = isAsync ? this.UKNOWN_PROP_ASYNC_WRAPPER_OPEN : this.UKNOWN_PROP_WRAPPER_OPEN;
        const wrapperClose = isAsync ? this.UNKOWN_PROP_ASYNC_WRAPPER_CLOSE : this.UNKOWN_PROP_WRAPPER_CLOSE;
        parsedArg = parsedArg ? ", " + parsedArg : "";
  ...
  printDynamicCall(node, identation) {
    const elementAccess = node.expression;
    if (_optionalChain([elementAccess, 'optionalAccess', _307 => _307.kind]) === _typescript2.default.SyntaxKind.ElementAccessExpression) {
      const argumentDepth = this.goExprDepth + (_optionalChain([node, 'access', _308 => _308.arguments, 'optionalAccess', _309 => _309.length]) > 0 ? 1 : 0);
      const parsedArg = _optionalChain([node, 'access', _310 => _310.arguments, 'optionalAccess', _311 => _311.length]) > 0 ? node.arguments.map((n) => this.goWithExprDepth(argumentDepth, () => this.printNode(n, identation).trimStart())).join(", ") : "";
  ...
  printWrappedUnknownThisProperty(node, identation = 0) {
    const type = this.getChecker().getResolvedSignature(node);
    if (_optionalChain([type, 'optionalAccess', _312 => _312.declaration]) === void 0) {
      const argumentDepth = this.goExprDepth + (_optionalChain([node, 'access', _313 => _313.arguments, 'optionalAccess', _314 => _314.length]) > 0 ? 1 : 0);
      let parsedArguments = _optionalChain([node, 'access', _315 => _315.arguments, 'optionalAccess', _316 => _316.map, 'call', _317 => _317((a) => this.goWithExprDepth(argumentDepth, () => this.printNode(a, identation).trimStart())), 'access', _318 => _318.join, 'call', _319 => _319(", ")]);
      parsedArguments = parsedArguments ? parsedArguments : "";
      const propName = _optionalChain([node, 'access', _320 => _320.expression, 'optionalAccess', _321 => _321.name, 'access', _322 => _322.escapedText]);
  ...
  printOutOfOrderCallExpressionIfAny(node, identation) {
    if (node.expression.kind === _typescript2.default.SyntaxKind.PropertyAccessExpression) {
      ...
      const leftSide = _optionalChain([node, 'access', _323 => _323.expression, 'optionalAccess', _324 => _324.expression]);
      const leftSideText = leftSide ? this.printNode(leftSide, 0) : void 0;
      if (leftSideText === this.THIS_TOKEN || leftSide.getFullText().indexOf("(this as any)") > -1) {
...
`;
  ...
  goIsAnyBoxExpression(node, printedText) {
    if (_optionalChain([node, 'optionalAccess', _325 => _325.kind]) === _typescript2.default.SyntaxKind.Identifier) {
      let symbol;
      try {
        symbol = this.getChecker().getSymbolAtLocation(node);
      } catch (e) {
      ...
      const decl = _optionalChain([symbol, 'optionalAccess', _326 => _326.valueDeclaration]);
      const isBinding = _optionalChain([decl, 'optionalAccess', _327 => _327.kind]) === _typescript2.default.SyntaxKind.Parameter || _optionalChain([decl, 'optionalAccess', _328 => _328.kind]) === _typescript2.default.SyntaxKind.VariableDeclaration;
      if (!isBinding) {
        return false;
      }
      return this.goDeclaredTypeOfIdentifier(node) === void 0;
    }
    if (_optionalChain([node, 'optionalAccess', _329 => _329.kind]) === _typescript2.default.SyntaxKind.CallExpression) {
  ...
  goScalarFamilyOfType(type, allowNil = false) {
    ...
    const alias = _optionalChain([type, 'access', _330 => _330.aliasSymbol, 'optionalAccess', _331 => _331.escapedName]);
    if (!allowNil) {
      switch (alias) {
        case "Str":
        case "Int":
  ...
  goDeclaredTypeOfIdentifier(node) {
    ...
    const decl = _optionalChain([symbol, 'optionalAccess', _333 => _333.valueDeclaration]);
    if (decl === void 0 || decl.kind !== _typescript2.default.SyntaxKind.VariableDeclaration) {
      return void 0;
    }
    if (decl.initializer === void 0 || _optionalChain([decl, 'access', _334 => _334.name, 'optionalAccess', _335 => _335.kind]) !== _typescript2.default.SyntaxKind.Identifier) {
      return void 0;
    }
  ...
  goPointerTypeOfExpression(node, printedText) {
    ...
    if (_optionalChain([node, 'optionalAccess', _336 => _336.kind]) === _typescript2.default.SyntaxKind.CallExpression) {
      const goType = this.goTypeOfInitializer(node, printedText);
  ...
  goElementAssignmentContainerType(node, printedText) {
    ...
    if (_optionalChain([node, 'optionalAccess', _337 => _337.kind]) === _typescript2.default.SyntaxKind.CallExpression) {
  ...
  goSliceIndexProvablyInRange(node, indexNode) {
    if (_optionalChain([node, 'optionalAccess', _338 => _338.kind]) !== _typescript2.default.SyntaxKind.Identifier || _optionalChain([indexNode, 'optionalAccess', _339 => _339.kind]) !== _typescript2.default.SyntaxKind.NumericLiteral) {
      return false;
    }
    ...
    const decl = _optionalChain([symbol, 'optionalAccess', _340 => _340.valueDeclaration]);
    if (decl === void 0 || decl.kind !== _typescript2.default.SyntaxKind.VariableDeclaration || _optionalChain([decl, 'access', _341 => _341.name, 'optionalAccess', _342 => _342.kind]) !== _typescript2.default.SyntaxKind.Identifier) {
      return false;
    }
    const initializer = decl.initializer;
    if (_optionalChain([initializer, 'optionalAccess', _343 => _343.kind]) !== _typescript2.default.SyntaxKind.ArrayLiteralExpression) {
      return false;
    }
  ...
  goRebindingTargetOf(identifier) {
    let node = identifier;
    let parent = node.parent;
    while (_optionalChain([parent, 'optionalAccess', _344 => _344.kind]) === _typescript2.default.SyntaxKind.ArrayLiteralExpression) {
      node = parent;
      parent = parent.parent;
    }
    if (_optionalChain([parent, 'optionalAccess', _345 => _345.kind]) === _typescript2.default.SyntaxKind.ForOfStatement && parent.initializer === node) {
      return parent;
    }
    if (_optionalChain([parent, 'optionalAccess', _346 => _346.kind]) === _typescript2.default.SyntaxKind.BinaryExpression && parent.left === node) {
      const op = parent.operatorToken.kind;
  ...
  goPrintedTypeOfExpression(node, printedText) {
    const inner = _optionalChain([node, 'optionalAccess', _347 => _347.kind]) === _typescript2.default.SyntaxKind.ParenthesizedExpression ? node.expression : node;
    if (_optionalChain([inner, 'optionalAccess', _348 => _348.kind]) === _typescript2.default.SyntaxKind.Identifier) {
...
${this.getIden(level)}}()`;
  ...
  printInlineOpNeg(node, printedText) {
    ...
    if (/^\d+(\.\d+)?([eE][+-]?\d+)?$/.test(printedText.trim())) {
      ...
      const parent = node.parent;
      if (_optionalChain([parent, 'optionalAccess', _349 => _349.kind]) === _typescript2.default.SyntaxKind.CallExpression) {
        const callee = this.printNode(parent.expression, 0);
        if (this.comparisonHelpers.indexOf(callee) >= 0) {
          return `-${printedText}`;
        }
      }
      if (_optionalChain([parent, 'optionalAccess', _350 => _350.kind]) === _typescript2.default.SyntaxKind.BinaryExpression) {
        const op = parent.operatorToken.kind;
  ...
  printInlineTruthy(node) {
    if (_optionalChain([node, 'optionalAccess', _351 => _351.kind]) !== _typescript2.default.SyntaxKind.Identifier) {
      return void 0;
    }
    const goType = this.goDeclaredTypeOfIdentifier(node);
    if (goType === void 0) {
  ...
  goNativeCondition(node) {
    if (_optionalChain([node, 'optionalAccess', _352 => _352.kind]) === _typescript2.default.SyntaxKind.Identifier) {
      return this.printInlineTruthy(node);
    }
    if (_optionalChain([node, 'optionalAccess', _353 => _353.kind]) === _typescript2.default.SyntaxKind.ParenthesizedExpression) {
  ...
  goIsControlClauseCondition(node) {
    const parent = _optionalChain([node, 'optionalAccess', _354 => _354.parent]);
    switch (_optionalChain([parent, 'optionalAccess', _355 => _355.kind])) {
      case _typescript2.default.SyntaxKind.IfStatement:
      case _typescript2.default.SyntaxKind.WhileStatement:
  ...
  printCondition(node, identation) {
    ...
    const inNode = _optionalChain([node, 'optionalAccess', _356 => _356.kind]) === _typescript2.default.SyntaxKind.ParenthesizedExpression ? node.expression : node;
    if (_optionalChain([inNode, 'optionalAccess', _357 => _357.kind]) === _typescript2.default.SyntaxKind.BinaryExpression && inNode.operatorToken.kind === _typescript2.default.SyntaxKind.InKeyword) {
  ...
  goDerefComparableWith(ptrNode, ptrText, otherNode) {
    const pointee = _optionalChain([this, 'access', _358 => _358.goPointerTypeOfExpression, 'call', _359 => _359(ptrNode, ptrText), 'optionalAccess', _360 => _360.substring, 'call', _361 => _361(1)]);
    if (pointee === void 0) {
      return false;
    }
    switch (_optionalChain([otherNode, 'optionalAccess', _362 => _362.kind])) {
      case _typescript2.default.SyntaxKind.StringLiteral:
      case _typescript2.default.SyntaxKind.NoSubstitutionTemplateLiteral:
  ...
  printInlineEquality(left, right, leftText, rightText, isEq) {
    ...
    const lRepeatable = _optionalChain([left, 'optionalAccess', _363 => _363.kind]) === _typescript2.default.SyntaxKind.Identifier;
    const rRepeatable = _optionalChain([right, 'optionalAccess', _364 => _364.kind]) === _typescript2.default.SyntaxKind.Identifier;
    ...
    const isLiteral = (node) => {
      switch (_optionalChain([node, 'optionalAccess', _365 => _365.kind])) {
        case _typescript2.default.SyntaxKind.StringLiteral:
        case _typescript2.default.SyntaxKind.NoSubstitutionTemplateLiteral:
        case _typescript2.default.SyntaxKind.TrueKeyword:
        case _typescript2.default.SyntaxKind.FalseKeyword:
  ...
  goLiteralTypedLocalKind(node) {
    ...
    const declaration = _optionalChain([symbol, 'optionalAccess', _366 => _366.valueDeclaration]);
    if (_optionalChain([declaration, 'optionalAccess', _367 => _367.kind]) !== _typescript2.default.SyntaxKind.VariableDeclaration || declaration.initializer === void 0) {
      return void 0;
    }
    const declarationList = declaration.parent;
    if (_optionalChain([declarationList, 'optionalAccess', _368 => _368.kind]) !== _typescript2.default.SyntaxKind.VariableDeclarationList || _optionalChain([declarationList, 'access', _369 => _369.parent, 'optionalAccess', _370 => _370.kind]) === _typescript2.default.SyntaxKind.FirstStatement) {
      return void 0;
    }
  ...
  goNumericLiteralKind(node) {
    const text = _optionalChain([node, 'optionalAccess', _371 => _371.text]);
    if (text === void 0) {
      return void 0;
    }
  ...
  goLiteralFitsKind(node, kind) {
    const value = Number(_optionalChain([node, 'optionalAccess', _372 => _372.text, 'optionalAccess', _373 => _373.replaceAll, 'call', _374 => _374("_", "")]));
  ...
  goComparisonKind(left, leftKind, right, rightKind) {
    ...
    if (_optionalChain([left, 'optionalAccess', _375 => _375.kind]) === _typescript2.default.SyntaxKind.NumericLiteral && _optionalChain([right, 'optionalAccess', _376 => _376.kind]) !== _typescript2.default.SyntaxKind.NumericLiteral) {
      return this.goLiteralFitsKind(left, rightKind) ? rightKind : void 0;
    }
    if (_optionalChain([right, 'optionalAccess', _377 => _377.kind]) === _typescript2.default.SyntaxKind.NumericLiteral && _optionalChain([left, 'optionalAccess', _378 => _378.kind]) !== _typescript2.default.SyntaxKind.NumericLiteral) {
  ...
  printParenthesizedExpression(node, identation) {
    const expression = node.expression;
    if (_optionalChain([expression, 'optionalAccess', _379 => _379.kind]) === _typescript2.default.SyntaxKind.AsExpression) {
      return this.getIden(identation) + this.printNode(expression, 0);
    }
    if (_optionalChain([expression, 'optionalAccess', _380 => _380.kind]) === _typescript2.default.SyntaxKind.ArrowFunction) {
      return "";
    }
  ...
  printExpressionStatement(node, identation) {
    if (_optionalChain([node, 'optionalAccess', _381 => _381.expression, 'optionalAccess', _382 => _382.kind]) === _typescript2.default.SyntaxKind.AsExpression) {
...
${this.getIden(identation)}PanicOnError(${returnRandName})`;
  ...
  printReturnStatement(node, identation) {
    ...
    if (_optionalChain([node, 'optionalAccess', _383 => _383.expression, 'optionalAccess', _384 => _384.kind]) === _typescript2.default.SyntaxKind.AsExpression) {
      node = node.expression;
    }
    if (_optionalChain([node, 'optionalAccess', _385 => _385.expression, 'optionalAccess', _386 => _386.kind]) === _typescript2.default.SyntaxKind.AwaitExpression) {
...
${this.getIden(identation)}${returnStatement}`;
  ...
  goPrintCallArgument(argument, printedText) {
    if (_optionalChain([argument, 'optionalAccess', _387 => _387.kind]) !== _typescript2.default.SyntaxKind.BinaryExpression || printedText === void 0) {
      return printedText;
    }
  ...
  printArrayPushCall(node, identation, name = void 0, parsedArg = void 0) {
    ...
    parsedArg = this.goPrintCallArgument(_optionalChain([node, 'access', _388 => _388.arguments, 'optionalAccess', _389 => _389[0]]), parsedArg);
    if (_optionalChain([name, 'optionalAccess', _390 => _390.startsWith, 'call', _391 => _391("GetValue")]) || /[\])]$/.test(_nullishCoalesce(name, () => ( "")))) {
...
${this.getIden(identation)}`;
  ...
  printSliceCall(node, identation, name = void 0, parsedArg = void 0, parsedArg2 = void 0) {
    parsedArg = this.goPrintCallArgument(_optionalChain([node, 'access', _392 => _392.arguments, 'optionalAccess', _393 => _393[0]]), parsedArg);
    parsedArg2 = this.goPrintCallArgument(_optionalChain([node, 'access', _394 => _394.arguments, 'optionalAccess', _395 => _395[1]]), parsedArg2);
    if (parsedArg2 === void 0) {
      parsedArg2 = "nil";
    }
    return `Slice(${name}, ${parsedArg}, ${parsedArg2})`;
  ...
  printThrowStatement(node, identation) {
    ...
    if (node.expression.kind === _typescript2.default.SyntaxKind.NewExpression) {
      const expression = node.expression;
      const argumentsExp = _nullishCoalesce(_optionalChain([expression, 'optionalAccess', _396 => _396.arguments]), () => ( []));
      const parsedArg = _nullishCoalesce(argumentsExp.map((n) => this.printNode(n, 0)).join(","), () => ( ""));
      const newExpression = this.printNode(expression.expression, 0);
      if (expression.expression.kind === _typescript2.default.SyntaxKind.Identifier) {
        const id = expression.expression;
        const symbol = this.getChecker().getSymbolAtLocation(expression.expression);
        if (symbol) {
          const declarations = _nullishCoalesce(_optionalChain([this, 'access', _397 => _397.getChecker, 'call', _398 => _398(), 'access', _399 => _399.getDeclaredTypeOfSymbol, 'call', _400 => _400(symbol), 'access', _401 => _401.symbol, 'optionalAccess', _402 => _402.declarations]), () => ( []));
          const isClassDeclaration = declarations.find((l) => l.kind === _typescript2.default.SyntaxKind.InterfaceDeclaration || l.kind === _typescript2.default.SyntaxKind.ClassDeclaration);
          if (isClassDeclaration) {
          } else {
...
${this.getIden(identation)}return nil`;
  ...
  printBinaryExpression(node, identation) {
    ...
    if (operatorToken.kind === _typescript2.default.SyntaxKind.EqualsToken) {
      ...
      if (_optionalChain([right, 'optionalAccess', _403 => _403.kind]) === _typescript2.default.SyntaxKind.AwaitExpression || rightSide.startsWith("<-this.callInternal")) {
        const leftParsed = this.printNode(left, 0);
        const awaited = _optionalChain([right, 'optionalAccess', _404 => _404.kind]) === _typescript2.default.SyntaxKind.AwaitExpression ? this.printNode(right, identation) : rightSide;
        return `
...
${tryBodyBlock}
  ...
  printNewExpression(node, identation) {
    let expression = _optionalChain([node, 'access', _405 => _405.expression, 'optionalAccess', _406 => _406.escapedText]);
    expression = expression ? expression : this.printNode(node.expression);
  ...
  isGoThisPropertyAccessExpression(node) {
    return _optionalChain([node, 'optionalAccess', _407 => _407.kind]) === _typescript2.default.SyntaxKind.PropertyAccessExpression && _optionalChain([node, 'access', _408 => _408.expression, 'optionalAccess', _409 => _409.kind]) === _typescript2.default.SyntaxKind.ThisKeyword;
  }
  ...
  isGoElementAccessAssignmentTarget(node) {
    const parent = node.parent;
    return _optionalChain([parent, 'optionalAccess', _410 => _410.kind]) === _typescript2.default.SyntaxKind.BinaryExpression && parent.left === node && (parent.operatorToken.kind === _typescript2.default.SyntaxKind.EqualsToken || parent.operatorToken.kind === _typescript2.default.SyntaxKind.PlusEqualsToken);
  }
  printElementAccessExpression(node, identation) {
...
var JavaTranspiler = class extends BaseTranspiler {
  ...
  countRequiredParameters(declaration) {
    const params = _nullishCoalesce(_optionalChain([declaration, 'optionalAccess', _411 => _411.parameters]), () => ( []));
    let required = 0;
  ...
  printArgsForCallExpression(node, identation) {
    ...
    const isThisCall = _optionalChain([callee, 'optionalAccess', _412 => _412.kind]) === _typescript2.default.SyntaxKind.PropertyAccessExpression && _optionalChain([callee, 'access', _413 => _413.expression, 'optionalAccess', _414 => _414.kind]) === _typescript2.default.SyntaxKind.ThisKeyword;
    if (isThisCall && args.length > 0) {
      ...
      if (isNullish) {
        ...
        const declaration = _optionalChain([signature, 'optionalAccess', _415 => _415.declaration]);
        if (declaration !== void 0) {
  ...
  printIdentifier(node) {
    ...
    const isInsideNewExpression = _optionalChain([node, 'optionalAccess', _416 => _416.parent, 'optionalAccess', _417 => _417.kind]) === _typescript2.default.SyntaxKind.NewExpression;
    const isInsideCatch = _optionalChain([node, 'optionalAccess', _418 => _418.parent, 'optionalAccess', _419 => _419.kind]) === _typescript2.default.SyntaxKind.ThrowStatement;
    const isLeftSide = _optionalChain([node, 'optionalAccess', _420 => _420.parent, 'optionalAccess', _421 => _421.name]) === node || _optionalChain([node, 'optionalAccess', _422 => _422.parent, 'optionalAccess', _423 => _423.left]) === node;
    const isCallOrPropertyAccess = _optionalChain([node, 'optionalAccess', _424 => _424.parent, 'optionalAccess', _425 => _425.kind]) === _typescript2.default.SyntaxKind.PropertyAccessExpression || _optionalChain([node, 'optionalAccess', _426 => _426.parent, 'optionalAccess', _427 => _427.kind]) === _typescript2.default.SyntaxKind.ElementAccessExpression;
    if (!isLeftSide && !isCallOrPropertyAccess && !isInsideCatch && !isInsideNewExpression) {
      const type = this.getChecker().getTypeAtLocation(node);
      const typeSymbol = _optionalChain([type, 'optionalAccess', _428 => _428.symbol]);
      if (typeSymbol !== void 0) {
        const decl = _nullishCoalesce(_optionalChain([typeSymbol, 'optionalAccess', _429 => _429.declarations]), () => ( []));
        let isBuiltIn = void 0;
        if (decl.length > 0) {
          isBuiltIn = decl[0].getSourceFile().fileName.indexOf("typescript") > -1;
        }
        if (isBuiltIn !== void 0 && !isBuiltIn) {
          ...
          if (symbol) {
            ...
            if (first.kind === _typescript2.default.SyntaxKind.ImportSpecifier) {
              ...
              if (_optionalChain([importedSymbol, 'optionalAccess', _430 => _430.declarations, 'access', _431 => _431[0], 'optionalAccess', _432 => _432.kind]) === _typescript2.default.SyntaxKind.ClassDeclaration) {
                isClassDeclaration = true;
              }
            }
          }
  ...
  printConstructorDeclaration(node, identation) {
    ...
    let superCallParams = "";
    let hasSuperCall = false;
    _optionalChain([node, 'access', _433 => _433.body, 'optionalAccess', _434 => _434.statements, 'access', _435 => _435.forEach, 'call', _436 => _436((statement) => {
      if (_typescript2.default.isExpressionStatement(statement)) {
        const expression = statement.expression;
        if (_typescript2.default.isCallExpression(expression)) {
          const expressionText = expression.expression.getText().trim();
  ...
  printDynamicCall(node, identation) {
    const elementAccess = node.expression;
    if (_optionalChain([elementAccess, 'optionalAccess', _437 => _437.kind]) === _typescript2.default.SyntaxKind.ElementAccessExpression) {
      const parsedArg = _optionalChain([node, 'access', _438 => _438.arguments, 'optionalAccess', _439 => _439.length]) > 0 ? node.arguments.map((n) => this.printNode(n, identation).trimStart()).join(", ") : "";
      const target = this.printNode(elementAccess.expression, 0);
      const propName = this.printNode(elementAccess.argumentExpression, 0);
      const argsArray = `new Object[] { ${parsedArg} }`;
      const open = this.DYNAMIC_CALL_OPEN;
  ...
  getExpressionStatementPrefixesIfAny(node, identation) {
    const finalVars = [];
    if (_optionalChain([node, 'access', _440 => _440.expression, 'optionalAccess', _441 => _441.kind]) === _typescript2.default.SyntaxKind.CallExpression) {
  ...
  printWrappedUnknownThisProperty(node) {
    const type = this.getChecker().getResolvedSignature(node);
    if (_optionalChain([type, 'optionalAccess', _442 => _442.declaration]) === void 0) {
      let parsedArguments = _optionalChain([node, 'access', _443 => _443.arguments, 'optionalAccess', _444 => _444.map, 'call', _445 => _445((a) => this.printNode(a, 0)), 'access', _446 => _446.join, 'call', _447 => _447(", ")]);
      parsedArguments = parsedArguments ? parsedArguments : "";
      const propName = _optionalChain([node, 'access', _448 => _448.expression, 'optionalAccess', _449 => _449.name, 'access', _450 => _450.escapedText]);
      const isAsyncDecl = _optionalChain([node, 'optionalAccess', _451 => _451.parent, 'optionalAccess', _452 => _452.kind]) === _typescript2.default.SyntaxKind.AwaitExpression;
      const argsArray = `new Object[] { ${parsedArguments} }`;
      const open = this.DYNAMIC_CALL_OPEN;
  ...
  printOutOfOrderCallExpressionIfAny(node, identation) {
    if (node.expression.kind === _typescript2.default.SyntaxKind.PropertyAccessExpression) {
      ...
      const leftSide = _optionalChain([node, 'access', _453 => _453.expression, 'optionalAccess', _454 => _454.expression]);
      const leftSideText = leftSide ? this.printNode(leftSide, 0) : void 0;
      if (leftSideText === this.THIS_TOKEN || leftSide.getFullText().indexOf("(this as any)") > -1) {
        const res = this.printWrappedUnknownThisProperty(node);
        if (res)
  ...
  getVarMethodIfAny(node) {
    let current = _optionalChain([node, 'optionalAccess', _455 => _455.parent]);
    while (current) {
      if (_typescript2.default.isMethodDeclaration(current) || _typescript2.default.isFunctionDeclaration(current)) {
        return String(_nullishCoalesce(_optionalChain([current, 'access', _456 => _456.name, 'optionalAccess', _457 => _457.escapedText]), () => ( "")));
      }
      current = current.parent;
    }
  ...
  getVarClassIfAny(node) {
    let current = _optionalChain([node, 'optionalAccess', _458 => _458.parent]);
    while (current) {
      if (_typescript2.default.isClassDeclaration(current)) {
        return String(_nullishCoalesce(_optionalChain([current, 'access', _459 => _459.name, 'optionalAccess', _460 => _460.escapedText]), () => ( "")));
      }
      current = current.parent;
    }
    return "";
  ...
  getVarKey(node) {
    const varName = _nullishCoalesce(_optionalChain([node, 'optionalAccess', _461 => _461.escapedText]), () => ( _optionalChain([node, 'optionalAccess', _462 => _462.name, 'optionalAccess', _463 => _463.escapedText])));
    if (!varName) {
      return "";
    }
  ...
  isNullishLiteral(node) {
    return _optionalChain([node, 'optionalAccess', _464 => _464.kind]) === _typescript2.default.SyntaxKind.NullKeyword || _optionalChain([node, 'optionalAccess', _465 => _465.kind]) === _typescript2.default.SyntaxKind.Identifier && node.escapedText === "undefined";
  }
  ...
  printNativeEqualityIfProvable(node, leftText, rightText) {
    ...
    const checker = this.getChecker();
    const leftFamily = this.equalityOperandFamily(_optionalChain([checker, 'optionalAccess', _466 => _466.getTypeAtLocation, 'call', _467 => _467(node.left)]));
    const rightFamily = this.equalityOperandFamily(_optionalChain([checker, 'optionalAccess', _468 => _468.getTypeAtLocation, 'call', _469 => _469(node.right)]));
  ...
  isVarargsArrayReference(node, depth = 0) {
    ...
    const symbol = this.getChecker().getSymbolAtLocation(node);
    const declaration = _nullishCoalesce(_optionalChain([symbol, 'optionalAccess', _470 => _470.valueDeclaration]), () => ( _optionalChain([symbol, 'optionalAccess', _471 => _471.declarations, 'optionalAccess', _472 => _472[0]])));
    if (!declaration) {
      return false;
    }
  ...
  isJavaListType(type) {
    ...
    return _optionalChain([type, 'access', _473 => _473.target, 'optionalAccess', _474 => _474.symbol, 'optionalAccess', _475 => _475.escapedName]) === "ReadonlyArray";
  }
  ...
  isJavaPrimitiveForCounter(node) {
    ...
    if (!incrementor || _optionalChain([incrementor, 'access', _476 => _476.operand, 'optionalAccess', _477 => _477.kind]) !== _typescript2.default.SyntaxKind.Identifier || incrementor.operand.escapedText !== node.escapedText) {
      return false;
    }
  ...
  isJavaMapType(type) {
    ...
    const declarations = _nullishCoalesce(_optionalChain([type, 'access', _478 => _478.getSymbol, 'call', _479 => _479(), 'optionalAccess', _480 => _480.declarations]), () => ( []));
...
`;
  ...
  isJavaMapStructureType(type) {
    ...
    const declaration = _optionalChain([symbol, 'optionalAccess', _481 => _481.declarations, 'optionalAccess', _482 => _482[0]]);
    const fileName = _optionalChain([declaration, 'optionalAccess', _483 => _483.getSourceFile, 'optionalCall', _484 => _484(), 'optionalAccess', _485 => _485.fileName]);
  ...
  tupleRequiredElementCount(type) {
    const flags = _nullishCoalesce(_nullishCoalesce(_optionalChain([type, 'optionalAccess', _486 => _486.target, 'optionalAccess', _487 => _487.elementFlags]), () => ( _optionalChain([type, 'optionalAccess', _488 => _488.elementFlags]))), () => ( []));
    let required = 0;
  ...
  isLeftSideOfAssignment(node) {
    const parent = node.parent;
    if (_optionalChain([parent, 'optionalAccess', _489 => _489.kind]) !== _typescript2.default.SyntaxKind.BinaryExpression || parent.left !== node) {
      return false;
    }
  ...
  javaNativeConcat(node) {
    if (_optionalChain([node, 'optionalAccess', _490 => _490.operatorToken, 'optionalAccess', _491 => _491.kind]) !== _typescript2.default.SyntaxKind.PlusToken) {
      return false;
    }
  ...
  javaNativeArithmeticKind(node) {
    const op = _optionalChain([node, 'optionalAccess', _492 => _492.operatorToken, 'optionalAccess', _493 => _493.kind]);
  ...
  getObjectLiteralFromCallExpressionArguments(node) {
    const res = [];
    if (!_optionalChain([node, 'optionalAccess', _494 => _494.arguments])) {
      return res;
    }
    const args = node.arguments;
  ...
  getBinaryExpressionPrefixes(node, identation) {
    let right = _optionalChain([node, 'optionalAccess', _495 => _495.right]);
    if (_optionalChain([right, 'optionalAccess', _496 => _496.kind]) === _typescript2.default.SyntaxKind.AwaitExpression) {
  ...
  analyzeFinalVars(fnBody) {
    ...
    const symbolIdOf = (n) => {
      try {
        const checker = this.getChecker();
        const sym = _optionalChain([checker, 'optionalAccess', _497 => _497.getSymbolAtLocation, 'optionalCall', _498 => _498(n)]);
        const decl = _nullishCoalesce(_optionalChain([sym, 'optionalAccess', _499 => _499.declarations, 'optionalAccess', _500 => _500[0]]), () => ( _optionalChain([sym, 'optionalAccess', _501 => _501.valueDeclaration])));
        if (decl)
    ...
    const discoverPotentialReassignments = (node) => {
      if (!node)
        return;
      if (node.kind === _typescript2.default.SyntaxKind.BinaryExpression) {
        if (_optionalChain([node, 'access', _502 => _502.left, 'optionalAccess', _503 => _503.kind]) === _typescript2.default.SyntaxKind.Identifier) {
          reassignedSyms.add(symbolIdOf(node.left));
        } else if (node.operatorToken.kind === _typescript2.default.SyntaxKind.EqualsToken && _optionalChain([node, 'access', _504 => _504.left, 'optionalAccess', _505 => _505.kind]) === _typescript2.default.SyntaxKind.ArrayLiteralExpression) {
          for (const elem of _nullishCoalesce(node.left.elements, () => ( []))) {
            if (_optionalChain([elem, 'optionalAccess', _506 => _506.kind]) === _typescript2.default.SyntaxKind.Identifier) {
              reassignedSyms.add(symbolIdOf(elem));
            }
          }
        }
      }
      if ((node.kind === _typescript2.default.SyntaxKind.PrefixUnaryExpression || node.kind === _typescript2.default.SyntaxKind.PostfixUnaryExpression) && this.isIncDecOperator(node.operator) && _optionalChain([node, 'access', _507 => _507.operand, 'optionalAccess', _508 => _508.kind]) === _typescript2.default.SyntaxKind.Identifier) {
        reassignedSyms.add(symbolIdOf(node.operand));
      }
      if (node.kind === _typescript2.default.SyntaxKind.Identifier) {
        const name = node.escapedText;
        if (name && name !== "undefined" && !_optionalChain([name, 'access', _509 => _509.startsWith, 'optionalCall', _510 => _510("null")])) {
    ...
    const visitExprInObjLit = (n) => {
      ...
      if (n.kind === _typescript2.default.SyntaxKind.Identifier) {
        ...
        if (name && name !== "undefined" && !_optionalChain([name, 'access', _511 => _511.startsWith, 'optionalCall', _512 => _512("null")])) {
      ...
      if (n.kind === _typescript2.default.SyntaxKind.CallExpression) {
        _optionalChain([n, 'access', _513 => _513.arguments, 'optionalAccess', _514 => _514.forEach, 'call', _515 => _515(visitExprInObjLit)]);
        if (_optionalChain([n, 'access', _516 => _516.expression, 'optionalAccess', _517 => _517.kind]) === _typescript2.default.SyntaxKind.PropertyAccessExpression) {
      ...
      if (n.kind === _typescript2.default.SyntaxKind.ElementAccessExpression) {
        ...
        while (_optionalChain([left, 'optionalAccess', _518 => _518.kind]) === _typescript2.default.SyntaxKind.ElementAccessExpression) {
      ...
      if (n.kind === _typescript2.default.SyntaxKind.ObjectLiteralExpression) {
        _optionalChain([n, 'access', _519 => _519.properties, 'optionalAccess', _520 => _520.forEach, 'call', _521 => _521((p) => {
          if (p.initializer)
    ...
    const walk = (node) => {
      ...
      if (node.kind === _typescript2.default.SyntaxKind.BinaryExpression && this.isAssignmentOperator(node.operatorToken.kind)) {
        walk(node.right);
        if (_optionalChain([node, 'access', _522 => _522.left, 'optionalAccess', _523 => _523.kind]) === _typescript2.default.SyntaxKind.Identifier) {
      ...
      if ((node.kind === _typescript2.default.SyntaxKind.PrefixUnaryExpression || node.kind === _typescript2.default.SyntaxKind.PostfixUnaryExpression) && this.isIncDecOperator(node.operator) && _optionalChain([node, 'access', _524 => _524.operand, 'optionalAccess', _525 => _525.kind]) === _typescript2.default.SyntaxKind.Identifier) {
      ...
      if (node.kind === _typescript2.default.SyntaxKind.ObjectLiteralExpression) {
        _optionalChain([node, 'access', _526 => _526.properties, 'optionalAccess', _527 => _527.forEach, 'call', _528 => _528((prop) => {
          if (prop.initializer) {
      ...
      if (node.kind === _typescript2.default.SyntaxKind.TryStatement) {
        ...
        walkBlockAndBump(_optionalChain([node, 'access', _529 => _529.catchClause, 'optionalAccess', _530 => _530.block]));
  ...
  getObjectLiteralId(node) {
    ...
    const fileName = _nullishCoalesce(_optionalChain([node, 'access', _531 => _531.getSourceFile, 'optionalCall', _532 => _532(), 'optionalAccess', _533 => _533.fileName]), () => ( ""));
  ...
  printVariableDeclarationList(node, identation) {
    ...
    if (this.removeVariableDeclarationForFunctionExpression && _optionalChain([declaration, 'optionalAccess', _534 => _534.initializer]) && _typescript2.default.isFunctionExpression(declaration.initializer)) {
      return this.printNode(declaration.initializer, identation).trimEnd();
    }
    if (_optionalChain([declaration, 'optionalAccess', _535 => _535.name, 'access', _536 => _536.kind]) === _typescript2.default.SyntaxKind.ArrayBindingPattern) {
      const arrayBindingPattern = declaration.name;
      const arrayBindingPatternElements = arrayBindingPattern.elements;
...
`;
    ...
    const isNew = _optionalChain([declaration, 'optionalAccess', _537 => _537.initializer]) && declaration.initializer.kind === _typescript2.default.SyntaxKind.NewExpression;
    const varToken = isNew ? "var " : this.VAR_TOKEN + " ";
    if (!declaration.initializer) {
      return this.getIden(identation) + "Object " + this.printNode(declaration.name) + " = " + this.UNDEFINED_TOKEN;
    }
  ...
  printThisKeyword(node, identation) {
    let current = _optionalChain([node, 'optionalAccess', _538 => _538.parent]);
    while (current) {
      ...
      current = _optionalChain([current, 'optionalAccess', _539 => _539.parent]);
    }
    return this.THIS_TOKEN;
  }
  transformPropertyAcessExpressionIfNeeded(node) {
  ...
  printCustomDefaultValueIfNeeded(node) {
    ...
    if (_optionalChain([node, 'optionalAccess', _540 => _540.escapedText]) === "undefined" && _optionalChain([this, 'access', _541 => _541.getChecker, 'call', _542 => _542(), 'access', _543 => _543.getTypeAtLocation, 'call', _544 => _544(_optionalChain([node, 'optionalAccess', _545 => _545.parent])), 'optionalAccess', _546 => _546.flags]) === _typescript2.default.TypeFlags.Number) {
      return this.UNDEFINED_TOKEN;
    }
    return void 0;
  }
  ...
  isPureInitializer(node) {
    switch (_optionalChain([node, 'optionalAccess', _547 => _547.kind])) {
      case _typescript2.default.SyntaxKind.NullKeyword:
      case _typescript2.default.SyntaxKind.TrueKeyword:
      case _typescript2.default.SyntaxKind.FalseKeyword:
      case _typescript2.default.SyntaxKind.StringLiteral:
...
`;
  ...
  printFinalOutsideMethodVariableWrappersIfAny(node, identation) {
    const parameters = _optionalChain([node, 'optionalAccess', _548 => _548.parameters]);
  ...
  printInsideMethodVariableWrappersIfAny(node, identation) {
    const parameters = _optionalChain([node, 'optionalAccess', _549 => _549.parameters]);
    const finalVarWrappers = [];
    if (parameters) {
      const isAsyncMethod = this.isAsyncFunction(node);
      parameters.forEach((param) => {
  ...
  printReplaceAllCall(node, identation, name = void 0, parsedArg = void 0, parsedArg2 = void 0) {
    const pattern = this.stringLiteralArgument(_optionalChain([node, 'optionalAccess', _550 => _550.arguments, 'optionalAccess', _551 => _551[0]]));
    const replacement = this.stringLiteralArgument(_optionalChain([node, 'optionalAccess', _552 => _552.arguments, 'optionalAccess', _553 => _553[1]]));
    const receiver = this.sideEffectFreeReceiver(_optionalChain([node, 'optionalAccess', _554 => _554.expression]));
  ...
  printThrowStatement(node, identation) {
    ...
    if (node.expression.kind === _typescript2.default.SyntaxKind.NewExpression) {
      const expression = node.expression;
      const argumentsExp = _nullishCoalesce(_optionalChain([expression, 'optionalAccess', _555 => _555.arguments]), () => ( []));
      const parsedArg = _nullishCoalesce(argumentsExp.map((n) => this.printNode(n, 0)).join(","), () => ( ""));
      const newExpression = this.printNode(expression.expression, 0);
      if (expression.expression.kind === _typescript2.default.SyntaxKind.Identifier) {
        const id = expression.expression;
        ...
        const symbol = this.getChecker().getSymbolAtLocation(expression.expression);
        if (symbol) {
          const declarations = _nullishCoalesce(_optionalChain([this, 'access', _556 => _556.getChecker, 'call', _557 => _557(), 'access', _558 => _558.getDeclaredTypeOfSymbol, 'call', _559 => _559(symbol), 'access', _560 => _560.symbol, 'optionalAccess', _561 => _561.declarations]), () => ( []));
...
var _RustTranspiler = class _RustTranspiler extends BaseTranspiler {
  ...
  printVariableDeclarationList(node, identation) {
    ...
    if (_optionalChain([declaration, 'optionalAccess', _562 => _562.name, 'access', _563 => _563.kind]) === SyntaxKind4.ArrayBindingPattern) {
...
`;
  ...
  rustNodeIsBoolExpression(node) {
    switch (_optionalChain([node, 'optionalAccess', _564 => _564.kind])) {
      case SyntaxKind4.TrueKeyword:
      case SyntaxKind4.FalseKeyword:
        return true;
      case SyntaxKind4.ParenthesizedExpression:
  ...
  rustEnclosingFunction(node) {
    let current = _optionalChain([node, 'optionalAccess', _565 => _565.parent]);
    while (current) {
      switch (current.kind) {
  ...
  rustBindsName(node, name) {
    switch (_optionalChain([node, 'optionalAccess', _566 => _566.kind])) {
      ...
      case SyntaxKind4.FunctionExpression:
      case SyntaxKind4.ArrowFunction:
        return _optionalChain([node, 'access', _567 => _567.name, 'optionalAccess', _568 => _568.kind]) === SyntaxKind4.Identifier && node.name.escapedText === name;
    }
    return false;
  }
  ...
  getRustBoolLocalInitializer(declaration, printedValue) {
    const initializer = declaration.initializer;
    if (initializer === void 0 || _optionalChain([declaration, 'access', _569 => _569.name, 'optionalAccess', _570 => _570.kind]) !== SyntaxKind4.Identifier) {
      return void 0;
    }
...
${classMethods}
  ...
  printFunctionDefinition(node, identation) {
    const name = _nullishCoalesce(_optionalChain([node, 'access', _571 => _571.name, 'optionalAccess', _572 => _572.escapedText]), () => ( ""));
    const params = node.parameters;
  ...
  printNewExpression(node, identation) {
    let expression = _optionalChain([node, 'access', _573 => _573.expression, 'optionalAccess', _574 => _574.escapedText]);
    expression = expression ? expression : this.printNode(node.expression);
  ...
  typeSymbolOf(type) {
    if (type === void 0 || type === null)
      return void 0;
    return _nullishCoalesce(_nullishCoalesce(_optionalChain([type, 'access', _575 => _575.getSymbol, 'optionalCall', _576 => _576()]), () => ( type.symbol)), () => ( type.aliasSymbol));
  }
  ...
  isLibDeclaredType(type) {
    const declarations = _nullishCoalesce(_optionalChain([this, 'access', _577 => _577.typeSymbolOf, 'call', _578 => _578(type), 'optionalAccess', _579 => _579.declarations]), () => ( []));
    return declarations.some((d) => {
      const file = _nullishCoalesce(_optionalChain([d, 'optionalAccess', _580 => _580.getSourceFile, 'optionalCall', _581 => _581(), 'optionalAccess', _582 => _582.fileName]), () => ( ""));
  ...
  isClassInstanceType(type) {
    ...
    if (_optionalChain([symbol, 'optionalAccess', _583 => _583.flags]) & _typescript2.default.SymbolFlags.Class)
      return true;
    const declarations = _nullishCoalesce(_optionalChain([symbol, 'optionalAccess', _584 => _584.declarations]), () => ( []));
  ...
  isProvenListType(type) {
    if (!(type.flags & _typescript2.default.TypeFlags.Object))
      return false;
    const objectFlags = (_nullishCoalesce(type.objectFlags, () => ( 0))) | (_nullishCoalesce(_optionalChain([type, 'access', _585 => _585.target, 'optionalAccess', _586 => _586.objectFlags]), () => ( 0)));
    if (objectFlags & _typescript2.default.ObjectFlags.Tuple)
      return true;
    const name = _optionalChain([this, 'access', _587 => _587.typeSymbolOf, 'call', _588 => _588(type), 'optionalAccess', _589 => _589.getName, 'optionalCall', _590 => _590()]);
    if (name === "Array" || name === "ReadonlyArray")
      return true;
    const targetName = _optionalChain([this, 'access', _591 => _591.typeSymbolOf, 'call', _592 => _592(type.target), 'optionalAccess', _593 => _593.getName, 'optionalCall', _594 => _594()]);
...
${idn}}`;
  ...
  printIfStatement(node, identation) {
    ...
    const elseStatement = node.elseStatement;
    if (_optionalChain([elseStatement, 'optionalAccess', _595 => _595.kind]) === SyntaxKind4.Block) {
      ifComplete += ` else${this.printBlock(elseStatement, identation)}`;
    } else if (_optionalChain([elseStatement, 'optionalAccess', _596 => _596.kind]) === SyntaxKind4.IfStatement) {
...
${this.getIden(identation)}})`;
  ...
  printIncludesCall(node, identation, name = void 0, parsedArg = void 0) {
    const pRef = _optionalChain([parsedArg, 'optionalAccess', _597 => _597.startsWith, 'call', _598 => _598("Value::")]) ? `&${parsedArg}` : `&${parsedArg}`;
  ...
  printTryStatement(node, identation) {
    ...
    const catchBody = node.catchClause.block.statements.map((s) => this.printNode(s, identation + 1)).join("\n");
    const rawName = _optionalChain([node, 'access', _599 => _599.catchClause, 'optionalAccess', _600 => _600.variableDeclaration, 'optionalAccess', _601 => _601.name, 'optionalAccess', _602 => _602.escapedText]);
...
var CppTranspiler = class extends BaseTranspiler {
  ...
  printConstructorDeclaration(node, identation) {
    ...
    let superCallParams = "";
    let hasSuperCall = false;
    _optionalChain([node, 'access', _603 => _603.body, 'optionalAccess', _604 => _604.statements, 'access', _605 => _605.forEach, 'call', _606 => _606((statement) => {
      if (_typescript2.default.isExpressionStatement(statement)) {
        const expression = statement.expression;
        if (_typescript2.default.isCallExpression(expression)) {
          const expressionText = expression.expression.getText().trim();
...
`;
  ...
  printVariableDeclarationList(node, identation) {
    const declaration = node.declarations[0];
    if (_optionalChain([declaration, 'optionalAccess', _607 => _607.name, 'access', _608 => _608.kind]) === _typescript2.default.SyntaxKind.ArrayBindingPattern) {
      const arrayBindingPattern = declaration.name;
      const arrayBindingPatternElements = arrayBindingPattern.elements;
      const parsedArrayBindingElements = arrayBindingPatternElements.map((e) => this.printNode(e.name, 0));
      const syntheticName = parsedArrayBindingElements.join("") + "Variable";
...
`;
  ...
  printThrowStatement(node, identation) {
    ...
    if (node.expression.kind === _typescript2.default.SyntaxKind.NewExpression) {
      const expression = node.expression;
      const argumentsExp = _nullishCoalesce(_optionalChain([expression, 'optionalAccess', _609 => _609.arguments]), () => ( []));
      const parsedArg = _nullishCoalesce(argumentsExp.map((n) => this.printNode(n, 0)).join(", "), () => ( ""));
      const newExpression = this.printNode(expression.expression, 0);
      if (expression.expression.kind === _typescript2.default.SyntaxKind.Identifier) {
        const id = expression.expression;
        const symbol = this.getChecker().getSymbolAtLocation(expression.expression);
        if (symbol) {
          const declarations = _nullishCoalesce(_optionalChain([this, 'access', _610 => _610.getChecker, 'call', _611 => _611(), 'access', _612 => _612.getDeclaredTypeOfSymbol, 'call', _613 => _613(symbol), 'access', _614 => _614.symbol, 'optionalAccess', _615 => _615.declarations]), () => ( []));
          const isClassDeclaration = declarations.find((l) => l.kind === _typescript2.default.SyntaxKind.InterfaceDeclaration || l.kind === _typescript2.default.SyntaxKind.ClassDeclaration);
          if (isClassDeclaration) {
...
function getProgramAndTypeCheckerFromMemory(rootDir, text, options = {}, cache) {
  ...
  const program = _typescript2.default.createProgram({
    ...
    host,
    oldProgram: _optionalChain([cache, 'optionalAccess', _616 => _616.memoryOldProgram])
  });
  if (cache !== void 0) {
