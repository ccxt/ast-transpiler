...
`;
  ...
  goFieldContainerTypeNative(node) {
    if (_optionalChain([node, 'optionalAccess', _304 => _304.kind]) !== _typescript2.default.SyntaxKind.PropertyAccessExpression || _optionalChain([node, 'access', _305 => _305.expression, 'optionalAccess', _306 => _306.kind]) !== _typescript2.default.SyntaxKind.ThisKeyword) {
      return void 0;
    }
    const name = _optionalChain([node, 'access', _307 => _307.name, 'optionalAccess', _308 => _308.escapedText]);
