...
`;
  ...
  goObjectBoxParameter(node) {
    ...
    if (_optionalChain([symbol, 'optionalAccess', _280 => _280.valueDeclaration, 'optionalAccess', _281 => _281.kind]) !== _typescript2.default.SyntaxKind.Parameter) {
      return false;
    }
    let type;
    try {
  ...
  goTypeIsNilComparableObject(type) {
    ...
    const declaration = _nullishCoalesce(_optionalChain([type, 'access', _282 => _282.symbol, 'optionalAccess', _283 => _283.valueDeclaration]), () => ( _optionalChain([type, 'access', _284 => _284.symbol, 'optionalAccess', _285 => _285.declarations, 'optionalAccess', _286 => _286[0]])));
    return _optionalChain([declaration, 'optionalAccess', _287 => _287.kind]) !== _typescript2.default.SyntaxKind.ClassDeclaration;
  }
