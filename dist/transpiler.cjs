...
`;
  ...
  javaIdentifierKeepsDeclaredName(node) {
    let declaration;
    try {
      declaration = _optionalChain([this, 'access', _458 => _458.getChecker, 'call', _459 => _459(), 'access', _460 => _460.getSymbolAtLocation, 'call', _461 => _461(node), 'optionalAccess', _462 => _462.valueDeclaration]);
    } catch (e) {
      return false;
    }
    ...
    return String(node.escapedText) === String(_optionalChain([declaration, 'access', _463 => _463.name, 'optionalAccess', _464 => _464.escapedText]));
  }
