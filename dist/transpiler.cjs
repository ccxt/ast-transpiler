...
`;
  ...
  goInferredLocalStaticType(node) {
    let declaration;
    try {
      declaration = _optionalChain([this, 'access', _216 => _216.getChecker, 'call', _217 => _217(), 'access', _218 => _218.getSymbolAtLocation, 'call', _219 => _219(node), 'optionalAccess', _220 => _220.valueDeclaration]);
    } catch (e) {
      return void 0;
    }
    ...
    if (_optionalChain([declarationList, 'optionalAccess', _222 => _222.kind]) !== _typescript2.default.SyntaxKind.VariableDeclarationList || _optionalChain([declarationList, 'access', _223 => _223.parent, 'optionalAccess', _224 => _224.kind]) === _typescript2.default.SyntaxKind.FirstStatement) {
      return void 0;
    }
