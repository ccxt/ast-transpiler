...
func (this *Test) TestJavaScope() {
	...
	fmt.Println(newObject["a"]) // should print 5
	fmt.Println(newObject["b"]) // should print 2
}
func (this *Test) Test() {
	var a any = 1
	var b any = 2
	...
	fmt.Println(len(dictKeys))         // should print 1
	...
	dict3["key"] = "value"
	fmt.Println(dict3["key"]) // should print "value"
	this.TestJavaScope()
